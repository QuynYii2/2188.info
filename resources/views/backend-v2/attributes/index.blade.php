    ...
    <div id="wpbody-content" class="snipcss-rFvJO">
        ...
        <div class="wrap woocommerce">
            ...
            <div id="message" class="updated woocommerce-message">
                <a class="woocommerce-message-close notice-dismiss" href="/wordpress/wp-admin/edit.php?post_type=product&amp;page=product_attributes&amp;wc-hide-notice=no_secure_connection&amp;_wc_notice_nonce=d6748f6d00">
                    Dismiss
                </a>
                <p>
                ...
                <div id="col-right">
                    <div class="col-wrap">
                        <table class="widefat attributes-table wp-list-table ui-sortable style-zkG8L" id="style-zkG8L">
                            ...
                            <tr class="alternate">
                                <td>
                                    <strong>
                                        <a href="edit-tags.php?taxonomy=pa_123&amp;post_type=product">
                                            123
                                        </a>
                                    </strong>
                                    <div class="row-actions">
                    <span class="edit">
                      <a href="edit.php?post_type=product&amp;page=product_attributes&amp;edit=1">
                        Edit
                      </a>
                      |
                    </span>
                                        <span class="delete">
                      <a class="delete" href="edit.php?post_type=product&amp;page=product_attributes&amp;delete=1&amp;_wpnonce=f73b353f9d">
                        Delete
                      </a>
                    </span>
                                    </div>
                  ...
                  <span class="na">
                    –
                                    ...
                                    <br>
                                    <a href="edit-tags.php?taxonomy=pa_123&amp;post_type=product" class="configure-terms">
                                        Configure terms
                                    </a>
                                </td>
                            </tr>
                        ...
                        <div class="form-wrap">
                            ...
                            <form action="edit.php?post_type=product&amp;page=product_attributes" method="post">
                                ...
                                <div class="form-field">
                                    ...
                                    <p class="description">
                                        Determines the sort order of the terms on the frontend shop product pages. If using custom ordering, you can drag and drop the terms in this attribute.
                                    </p>
                                </div>
                                <p class="submit">
                                    <button type="submit" name="add_new_attribute" id="submit" class="button button-primary" value="Add attribute">
                                        Add attribute
                                    </button>
                                </p>
                                <input type="hidden" id="_wpnonce" name="_wpnonce" value="43c46fa77f">
                                <input type="hidden" name="_wp_http_referer" value="/wordpress/wp-admin/edit.php?post_type=product&amp;page=product_attributes">
                            </form>
                        </div>
                    </div>
                </div>
