...
<head>
    ...
    <title>Attributes &lsaquo; Wordpress &#8212; WordPress</title>
    ...
    <script id='woocommerce_admin-js-extra'>
        var woocommerce_admin = {
            ...
            "nonces": {"gateway_toggle": "7ec6e2e491"},
            "urls": {
                "add_product": null,
    ...
    <script id='wc-enhanced-select-js-extra'>
        var wc_enhanced_select_params = {
            ...
            "ajax_url": "http:\/\/localhost\/wordpress\/wp-admin\/admin-ajax.php",
            "search_products_nonce": "093252d73f",
            "search_customers_nonce": "e3ce86693d",
            "search_categories_nonce": "dc61600d7d",
            "search_taxonomy_terms_nonce": "d62dc938d5",
            "search_product_attributes_nonce": "f41499f1f4",
            "search_pages_nonce": "e7d02a5cd6"
        };
    </script>

    <script>
        /* <![CDATA[ */
        var userSettings = {"url": "\/wordpress\/", "uid": "1", "time": "1689669410", "secure": ""};/* ]]> */
    </script>
    ...
    <link id="wp-admin-canonical" rel="canonical"
          href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;page=product_attributes"/>
    <script>
...
<div id="wpwrap">
    ...
    <div id="wpcontent">
        ...
        <div id="wpadminbar" class="nojq nojs">
                        ...
                        <div class="ab-sub-wrapper">
                            <ul id='wp-admin-bar-user-actions' class="ab-submenu">
                                ...
                                <li id='wp-admin-bar-logout'><a class='ab-item'
                                                                href='http://localhost/wordpress/wp-login.php?action=logout&#038;_wpnonce=9ecf2025ef'>Đăng
                                        xuất</a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <a class="screen-reader-shortcut"
               href="http://localhost/wordpress/wp-login.php?action=logout&#038;_wpnonce=9ecf2025ef">Đăng xuất</a>
        </div>
                ...
                <div class="woocommerce-layout__notice-list-hide" id="wp__notice-list">
                    <div id="message" class="updated woocommerce-message">
                        <a class="woocommerce-message-close notice-dismiss"
                           href="/wordpress/wp-admin/edit.php?post_type=product&#038;page=product_attributes&#038;wc-hide-notice=no_secure_connection&#038;_wc_notice_nonce=60fef79ab1">Dismiss</a>
                        ...
                        <div id="col-right">
                            <div class="col-wrap">
                                <table class="widefat attributes-table wp-list-table ui-sortable" style="width:100%">
                                    ...
                                    <tr>
                                        <td>
                                            <strong><a href="edit-tags.php?taxonomy=pa_123&amp;post_type=product">123</a></strong>

                                            <div class="row-actions"><span class="edit"><a
                                                            href="edit.php?post_type=product&#038;page=product_attributes&#038;edit=1">Edit</a> | </span><span
                                                        class="delete"><a class="delete"
                                                                          href="edit.php?post_type=product&#038;page=product_attributes&#038;delete=1&#038;_wpnonce=8d51bff66d">Delete</a></span>
                                            </div>
                                        </td>
                                        <td>123</td>
                                        <td>
                                        ...
                                        <td class="attribute-terms">
                                            <span class="na">&ndash;</span> <br/><a
                                                    href="edit-tags.php?taxonomy=pa_123&amp;post_type=product"
                                                    class="configure-terms">Configure terms</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div id="col-left">
                            <div class="col-wrap">
                                <div class="form-wrap">
                                    ...
                                    <p>Attributes let you define extra product data, such as size or color. You can use
                                        these attributes in the shop sidebar using the &quot;layered nav&quot;
                                        widgets.</p>
                                    <form action="edit.php?post_type=product&amp;page=product_attributes" method="post">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input name="attribute_name" id="attribute_name" type="text" value=""
                                                   maxlength="28"/>
                                            <p class="description">Unique slug/reference for the attribute; must be no
                                                more than 28 characters.</p>
                                        </div>

                                        <div class="form-field">
                                            <label for="attribute_public"><input name="attribute_public"
                                                                                 id="attribute_public" type="checkbox"
                                                                                 value="1"/> Enable Archives?</label>

                                            <p class="description">Enable this if you want this attribute to have
                                                product archives in your store.</p>
                                        </div>
                                        ...
                                        <div class="form-field">
                                            ...
                                            <p class="description">Determines the sort order of the terms on the
                                                frontend shop product pages. If using custom ordering, you can drag and
                                                drop the terms in this attribute.</p>
                                        </div>


                                        <p class="submit">
                                            <button type="submit" name="add_new_attribute" id="submit"
                                                    class="button button-primary" value="Add attribute">Add attribute
                                            </button>
                                        </p>
                                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="6a3eb91b49"/><input
                                                type="hidden" name="_wp_http_referer"
                                                value="/wordpress/wp-admin/edit.php?post_type=product&#038;page=product_attributes"/>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        window.wcTracks.recordEvent = function (name, properties) {
            ...
            eventProperties = {
                ...eventProperties, ...{
                    ...
                    "_dr": "",
                    "_dl": "http:\/\/localhost\/wordpress\/wp-admin\/edit.php?post_type=product&page=product_attributes",
    ...
    <script src='http://localhost/wordpress/wp-content/plugins/woocommerce/assets/client/admin/wp-admin-scripts/attributes-tracking.js?ver=7.9.0'
            id='wc-admin-attributes-tracking-js'></script>
