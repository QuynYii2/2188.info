...
<head>
    ...
    <title>Add new product &lsaquo; Wordpress &#8212; WordPress</title>
    ...
    <link rel='stylesheet'
          href='http://localhost/wordpress/wp-admin/load-styles.php?c=1&amp;dir=ltr&amp;load%5Bchunk_0%5D=dashicons,admin-bar,buttons,media-views,common,forms,admin-menu,dashboard,list-tables,edit,revisions,media,themes,about,nav-menu&amp;load%5Bchunk_1%5D=s,wp-pointer,widgets,site-icon,l10n,wp-auth-check,wp-color-picker,wp-components&amp;ver=6.2.2'
          media='all'/>
    <link rel='stylesheet' id='thickbox-css'
          href='http://localhost/wordpress/wp-includes/js/thickbox/thickbox.css?ver=6.2.2' media='all'/>
    ...
    <script>
        /* <![CDATA[ */
        var userSettings = {"url": "\/wordpress\/", "uid": "1", "time": "1689662091", "secure": ""};/* ]]> */
    </script>
    ...
    <script id='wc-admin-product-editor-js-extra'>
        var woocommerce_admin_product_editor = {"i18n_description": "Product description"};
    </script>
    <script src='http://localhost/wordpress/wp-content/plugins/woocommerce/assets/js/admin/product-editor.min.js?ver=7.9.0'
            id='wc-admin-product-editor-js'></script>
    ...
    <link id="wp-admin-canonical" rel="canonical"
          href="http://localhost/wordpress/wp-admin/post-new.php?post_type=product"/>
    <script>
        ...
        <div id="wpbody" role="main">
            ...
            <div id="wpbody-content">
                    ...
                    <div id="screen-options-wrap" class="hidden" tabindex="-1" aria-label="Khung Tùy Biến Màn Hình">
                        <form id='adv-settings' method='post'>
                            <fieldset class="metabox-prefs">
                                ...
                                <p>
                                    Some screen elements can be shown or hidden by using the checkboxes. Expand or
                                    collapse the elements by clicking on their headings, and arrange them by dragging
                                ...
                                <label for="product_catdiv-hide"><input class="hide-postbox-tog"
                                    ...
                                    categories</label><label for="tagsdiv-product_tag-hide"><input
                                            ...
                                            id="tagsdiv-product_tag-hide" value="tagsdiv-product_tag"
                                            checked='checked'/>Product tags</label><label for="postimagediv-hide"><input
                                            class="hide-postbox-tog" name="postimagediv-hide" type="checkbox"
                                            id="postimagediv-hide" value="postimagediv" checked='checked'/>Product image</label><label
                                        for="woocommerce-product-images-hide"><input class="hide-postbox-tog"
                                                                                     name="woocommerce-product-images-hide"
                                                                                     type="checkbox"
                                                                                     id="woocommerce-product-images-hide"
                                                                                     value="woocommerce-product-images"
                                                                                     checked='checked'/>Product gallery</label><label
                                        for="woocommerce-product-data-hide"><input class="hide-postbox-tog"
                                                                                   ...
                                                                                   checked='checked'/>Product
                                    data</label><label for="slugdiv-hide"><input class="hide-postbox-tog"
                                                                                 name="slugdiv-hide" type="checkbox"
                                                                                 id="slugdiv-hide" value="slugdiv"/>Đường
                                    dẫn</label><label for="postexcerpt-hide"><input class="hide-postbox-tog"
                                                                                    name="postexcerpt-hide"
                                                                                    type="checkbox"
                                                                                    id="postexcerpt-hide"
                                                                                    value="postexcerpt"
                                                                                    checked='checked'/>Product short
                                    description</label></fieldset>
                            <fieldset class='columns-prefs'>
                                <legend class="screen-layout">Bố cục</legend>
                            ...
                            <fieldset class="editor-expand hidden">
                                <legend>Tùy chọn bổ sung</legend>
                                <label for="editor-expand-toggle"><input type="checkbox" id="editor-expand-toggle"
                                                                         checked='checked'/>Bật trình soạn thảo văn bản
                                    toàn chiều cao và chức năng tránh mất tập trung.</label></fieldset>
                ...
                <div class="wrap">
                    ...
                    >
                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="9ee06bd7b6"/><input type="hidden"
                                                                                                      name="_wp_http_referer"
                                                                                                      value="/wordpress/wp-admin/post-new.php?post_type=product"/><input
                                type="hidden" id="user-id" name="user_ID" value="1"/>
                        ...
                        <input type="hidden" id="referredby" name="referredby"
                               value="http://localhost/wordpress/wp-admin/edit.php?post_type=product"/>
                        <input type="hidden" name="_wp_original_http_referer"
                               value="http://localhost/wordpress/wp-admin/edit.php?post_type=product"/><input
                                type='hidden' id='auto_draft' name='auto_draft' value='1'/><input type='hidden'
                                                                                                  id='post_ID'
                                                                                                  name='post_ID'
                                                                                                  value='43'/><input
                                type="hidden" id="meta-box-order-nonce" name="meta-box-order-nonce" value="5a9c70ec48"/><input
                                type="hidden" id="closedpostboxesnonce" name="closedpostboxesnonce" value="e165480476"/>
                        ...
                        <div id="poststuff">
                            <div id="post-body" class="metabox-holder columns-2">
                                <div id="post-body-content">
                                    ...
                                    <div id="titlediv">
                                        <div id="titlewrap">
                                            <label class="screen-reader-text" id="title-prompt-text" for="title">Product
                                                name</label>
                                        ...
                                        <input type="hidden" id="samplepermalinknonce" name="samplepermalinknonce"
                                               value="7b9c6f10bc"/></div><!-- /titlediv -->
                                    <div id="acf-form-data" class="acf-hidden">
                                        <input type="hidden" id="_acf_screen" name="_acf_screen" value="post"/><input
                                                type="hidden" id="_acf_post_id" name="_acf_post_id" value="43"/><input
                                                type="hidden" id="_acf_validation" name="_acf_validation"
                                                value="1"/><input type="hidden" id="_acf_nonce" name="_acf_nonce"
                                                                  value="ed8ebe20c0"/><input type="hidden"
                                                                                             id="_acf_changed"
                                                                                             name="_acf_changed"
                                                                                             value="0"/></div>
                                    <div id="acf_after_title-sortables" class="meta-box-sortables"></div>
                                    <style type="text/css" id="acf-style"></style>
                                    <div id="postdivrich" class="postarea wp-editor-expand">
                                        ...
                                        <div id="wp-content-wrap" class="wp-core-ui wp-editor-wrap tmce-active has-dfw">
                                            <link rel='stylesheet' id='editor-buttons-css'
                                                  href='http://localhost/wordpress/wp-includes/css/editor.min.css?ver=6.2.2'
                                                  media='all'/>
                                            <div id="wp-content-editor-tools" class="wp-editor-tools hide-if-no-js">
                                                <div id="wp-content-media-buttons" class="wp-media-buttons">
                                                    <button type="button" id="insert-media-button"
                                                        ...
                                                        <span class="wp-media-buttons-icon"></span> Thêm Media
                                                    </button>
                                                </div>
                                                <div class="wp-editor-tabs">
                                                    <button type="button" id="content-tmce"
                                                            class="wp-switch-editor switch-tmce"
                                                            data-wp-editor-id="content">Trực quan
                                                    </button>
                                                    <button type="button" id="content-html"
                                                            class="wp-switch-editor switch-html"
                                                            data-wp-editor-id="content">Văn bản
                                                    </button>
                                                </div>
                                            </div>
                                            <div id="wp-content-editor-container" class="wp-editor-container">
                                                <div id="ed_toolbar" class="quicktags-toolbar hide-if-no-js"></div>
                                                <textarea class="wp-editor-area" style="height: 300px"
                                                          autocomplete="off" cols="40" name="content"
                                        ...
                                        <table id="post-status-info">
                                            ...
                                            <tr>
                                                <td id="wp-word-count" class="hide-if-no-js">
                                                    Số từ: <span class="word-count">0</span></td>
                                ...
                                <div id="postbox-container-1" class="postbox-container">
                                    <div id="side-sortables" class="meta-box-sortables">
                                        <div id="submitdiv" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Đăng</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                            aria-describedby="submitdiv-handle-order-higher-description">
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                class="order-higher-indicator"
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden" id="submitdiv-handle-order-higher-description">Chuyển Đăng lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                            aria-describedby="submitdiv-handle-order-lower-description">
                                                        <span class="screen-reader-text">Di chuyển xuống</span><span
                                                                class="order-lower-indicator" aria-hidden="true"></span>
                                                    </button>
                                                    <span class="hidden" id="submitdiv-handle-order-lower-description">Chuyển Đăng xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Đăng</span><span
                                                    ...
                                                    <div id="minor-publishing">
                                                        ...
                                                        <div style="display:none;">
                                                            <p class="submit"><input type="submit" name="save" id="save"
                                                                                     class="button"
                                                                                     value="Lưu thay đổi"/></p></div>

                                                        <div id="minor-publishing-actions">
                                                            <div id="save-action">
                                                                <input type="submit" name="save" id="save-post"
                                                                       value="Lưu nháp" class="button"/>
                                                                <span class="spinner"></span>
                                                            </div>

                                                            <div id="preview-action">
                                                                <a class="preview button"
                                                                   href="http://localhost/wordpress/?post_type=product&#038;p=43&#038;preview=true"
                                                                   target="wp-preview-43" id="post-preview">Xem thử<span
                                                                            class="screen-reader-text"> (mở trong cửa sổ mới)</span></a>
                                                        ...
                                                        <div id="misc-publishing-actions">
                                                            <div class="misc-pub-section misc-pub-post-status">
                                                                Trạng thái: <span id="post-status-display">
				Bản nháp			</span>

                                                                <a href="#post_status"
                                                                   class="edit-post-status hide-if-no-js" role="button"><span
                                                                            aria-hidden="true">Chỉnh sửa</span> <span
                                                                            class="screen-reader-text">
					Chỉnh sửa trạng thái				</span></a>
                                                                ...
                                                                <div id="post-status-select" class="hide-if-js">
                                                                    ...
                                                                    <label for="post_status" class="screen-reader-text">
                                                                        Thiết lập trạng thái </label>
                                                                    <select name="post_status" id="post_status">
                                                                        <option value='pending'>Chờ duyệt</option>
                                                                        <option selected='selected' value='draft'>Bản
                                                                            nháp
                                                                        </option>
                                                                    </select>
                                                                    <a href="#post_status"
                                                                    ...
                                                                    <a href="#post_status"
                                                                       class="cancel-post-status hide-if-no-js button-cancel">Hủy</a>
                                                                </div>
                                                            </div>

                                                            <div class="misc-pub-section misc-pub-visibility"
                                                                 id="visibility">
                                                                Hiển thị: <span id="post-visibility-display">
				Công khai			</span>
                                                                ...
                                                                <div id="post-visibility-select" class="hide-if-js">
                                                                    ...
                                                                    <input type="radio" name="visibility"
                                                                           ...
                                                                           checked='checked'/> <label
                                                                            ...
                                                                            class="selectit">Công khai</label><br/>
                                                                    ...
                                                                    <input type="radio" name="visibility"
                                                                           ...
                                                                           value="password"/> <label
                                                                            ...
                                                                            class="selectit">Bảo vệ bằng mật
                                                                        khẩu</label><br/>
                                                                    <span id="password-span"><label for="post_password">Mật khẩu:</label> <input
                                                                                type="text" name="post_password"
                                                                                id="post_password" value=""
                                                                    ...
                                                                    <input type="radio" name="visibility"
                                                                           ...
                                                                           value="private"/> <label
                                                                            ...
                                                                            class="selectit">Riêng tư</label><br/>

                                                                    <p>
                                                                        <a href="#visibility"
                                                                           class="save-post-visibility hide-if-no-js button">Ok</a>
                                                                        <a href="#visibility"
                                                                           class="cancel-post-visibility hide-if-no-js button-cancel">Hủy</a>
                                                                    </p>
                                                                </div>
                                                            </div>
						...
						Chỉnh sửa ngày tháng và thời gian					</span>
                                                                ...
                                                                <fieldset id="timestampdiv" class="hide-if-js">
                                                                    ...
                                                                    <div class="timestamp-wrap"><label><span
                                                                                    class="screen-reader-text">Tháng</span><select
                                                                                    class="form-required" id="mm"
                                                                                    name="mm">
                                                                                ...
                                                                                <option value="07" data-text="Th7"
                                                                                        selected='selected'>07-Th7
                                                                                </option>
                                                                                ...
                                                                                <option value="12" data-text="Th12">
                                                                                    ...
                                                                                    class="screen-reader-text">Ban ngày</span><input
                                                                                    type="text" id="jj" name="jj"
                                                                                    value="18" size="2" maxlength="2"
                                                                                    autocomplete="off"
                                                                                    class="form-required"/></label>,
                                                                        <label><span
                                                                                    class="screen-reader-text">Năm</span><input
                                                                                    type="text" id="aa" name="aa"
                                                                                    value="2023" size="4" maxlength="4"
                                                                                    autocomplete="off"
                                                                                    class="form-required"/></label> vào
                                                                        lúc <label><span
                                                                                    class="screen-reader-text">Giờ</span><input
                                                                                    type="text" id="hh" name="hh"
                                                                                    value="06" size="2" maxlength="2"
                                                                                    autocomplete="off"
                                                                                    class="form-required"/></label>:<label><span
                                                                                    class="screen-reader-text">Phút</span><input
                                                                                    type="text" id="mn" name="mn"
                                                                                    value="34" size="2" maxlength="2"
                                                                                    autocomplete="off"
                                                                                    class="form-required"/></label>
                                                                    </div>
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <a href="#edit_timestamp"
                                                                           class="cancel-timestamp hide-if-no-js button-cancel">Hủy</a>
                                                                    </p>
                                                                </fieldset>
                                                            </div>
                                                            <div class="misc-pub-section" id="catalog-visibility">
                                                                ...
                                                                <div id="catalog-visibility-select" class="hide-if-js">
                                                                    ...
                                                                    <label for="_visibility_hidden" class="selectit">Hidden</label><br/><br/><input
                                                                            type="checkbox" name="_featured"
                                                                            id="_featured"/> <label for="_featured">This
                                                                        is a featured product</label><br/>
                                                                    <p>
                                                                        <a href="#catalog-visibility"
                                                                           class="save-post-visibility hide-if-no-js button">OK</a>
                                                                        <a href="#catalog-visibility"
                                                    ...
                                                    <div id="major-publishing-actions">
                                                        <div id="duplicate-action"><a
                                                                    ...
                                                                    href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;action=duplicate_product&#038;post=43&#038;_wpnonce=9d253b36d3">Copy
                                                                to a new draft</a></div>
                                                        <div id="delete-action">
                                                            <a class="submitdelete deletion"
                                                               href="http://localhost/wordpress/wp-admin/post.php?post=43&amp;action=trash&amp;_wpnonce=b6a7ce6445">Bỏ
                                                                vào thùng rác</a>
                                                        </div>
                                                        ...
                                                        <div id="publishing-action">
                                                            ...
                                                            <input name="original_publish" type="hidden"
                                                                   id="original_publish" value="Đăng"/>
                                        ...
                                        <div id="postimagediv" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product image</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                ...
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="postimagediv-handle-order-higher-description">Chuyển Product image lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden"
                                                          id="postimagediv-handle-order-lower-description">Chuyển Product image xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product image</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="inside">
                                                <p class="hide-if-no-js"><a
                                                            href="http://localhost/wordpress/wp-admin/media-upload.php?post_id=43&#038;type=image&#038;TB_iframe=1"
                                                            id="set-post-thumbnail" class="thickbox">Set product
                                                        image</a></p><input type="hidden" id="_thumbnail_id"
                                                                            name="_thumbnail_id" value="-1"/></div>
                                        </div>
                                        <div id="woocommerce-product-images" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product gallery</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                ...
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="woocommerce-product-images-handle-order-higher-description">Chuyển Product gallery lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden"
                                                          id="woocommerce-product-images-handle-order-lower-description">Chuyển Product gallery xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product gallery</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="inside">
                                                <input type="hidden" id="woocommerce_meta_nonce"
                                                       name="woocommerce_meta_nonce" value="1d033bb4a9"/><input
                                                        type="hidden" name="_wp_http_referer"
                                                        value="/wordpress/wp-admin/post-new.php?post_type=product"/>
                                        ...
                                        <div id="product_catdiv" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product categories</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                ...
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="product_catdiv-handle-order-higher-description">Chuyển Product categories lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden"
                                                          id="product_catdiv-handle-order-lower-description">Chuyển Product categories xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product categories</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="inside">
                                                <div id="taxonomy-product_cat" class="categorydiv">
                                                    <ul id="product_cat-tabs" class="category-tabs">
                                                        ...
                                                        <li class="hide-if-no-js"><a href="#product_cat-pop">Dùng nhiều
                                                                nhất</a></li>
                                                    </ul>
                                                        ...
                                                        <ul id="product_catchecklist-pop"
                                                            ...
                                                            <li id="popular-product_cat-18" class="popular-category">
                                                                <label class="selectit">
                                                                    <input id="in-popular-product_cat-18"
                                                    ...
                                                    <div id="product_cat-all" class="tabs-panel">
                                                        ...
                                                        <ul id="product_catchecklist" data-wp-lists="list:product_cat"
                                                            ...
                                                            <li id='product_cat-18' class="popular-category"><label
                                                                        class="selectit"><input value="18"
                                                                                                type="checkbox"
                                                                                                name="tax_input[product_cat][]"
                                                                                                id="in-product_cat-18"/>
                                                                    Uncategorized</label></li>

                                                            <li id='product_cat-19'><label class="selectit"><input
                                                                            value="19" type="checkbox"
                                                                            name="tax_input[product_cat][]"
                                                                            id="in-product_cat-19"/> gì cơ</label></li>
                                                        </ul>
                                                    </div>
                                                    <div id="product_cat-adder" class="wp-hidden-children">
                                                        ...
                                                        <p id="product_cat-add" class="category-add wp-hidden-child">
                                                            ...
                                                            <select name='newproduct_cat_parent'
                                                                ...
                                                                <option value='-1'>&mdash; Parent category &mdash;
                                                                </option>
                                                                <option class="level-0" value="19">gì cơ</option>
                                                                <option class="level-0" value="18">Uncategorized
                                                                </option>
                                                            </select>
                                        ...
                                        <div id="tagsdiv-product_tag" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product tags</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                ...
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="tagsdiv-product_tag-handle-order-higher-description">Chuyển Product tags lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden"
                                                          id="tagsdiv-product_tag-handle-order-lower-description">Chuyển Product tags xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product tags</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="jaxtag">
                                                        ...
                                                        <div class="ajaxtag hide-if-no-js">
                                                            ...
                                                            <input data-wp-taxonomy="product_tag" type="text"
                                                                   ...
                                                                   class="newtag form-input-tip" size="16"
                                                                   autocomplete="off"
                                                                   aria-describedby="new-tag-product_tag-desc"
                                                                   value=""/>
                                ...
                                <div id="postbox-container-2" class="postbox-container">
                                    <div id="normal-sortables" class="meta-box-sortables">
                                        <div id="woocommerce-product-data" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product data</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                            aria-describedby="woocommerce-product-data-handle-order-higher-description">
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                class="order-higher-indicator"
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="woocommerce-product-data-handle-order-higher-description">Chuyển Product data lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                            aria-describedby="woocommerce-product-data-handle-order-lower-description">
                                                        <span class="screen-reader-text">Di chuyển xuống</span><span
                                                                class="order-lower-indicator" aria-hidden="true"></span>
                                                    </button>
                                                    <span class="hidden"
                                                          id="woocommerce-product-data-handle-order-lower-description">Chuyển Product data xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product data</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
	...
	<span class="product-data-wrapper type_box hidden"> &mdash;
		<label for="product-type">
			...
			<span class="woocommerce-product-type-tip"></span>
					...
					<label for="_virtual" class="show_if_simple tips"
                           data-tip="Virtual products are intangible and are not shipped.">
				Virtual:
				<input type="checkbox" name="_virtual" id="_virtual" data-product-type-option-id="_virtual"/>
			</label>
					<label for="_downloadable" class="show_if_simple tips"
                           data-tip="Downloadable products give access to a file upon purchase.">
				Downloadable:
				<input type="checkbox" name="_downloadable" id="_downloadable"
                       data-product-type-option-id="_downloadable"/>
			</label>
			</span>
                                                    ...
                                                    <ul class="product_data_tabs wc-tabs">
                                                        ...
                                                        <li class="inventory_options inventory_tab show_if_simple show_if_variable show_if_grouped show_if_external">
                                                            <a href="#inventory_product_data"><span>Inventory</span></a>
                                                        </li>
                                                        <li class="shipping_options shipping_tab hide_if_virtual hide_if_grouped hide_if_external">
                                                            <a href="#shipping_product_data"><span>Shipping</span></a>
                                                        </li>
                                                        ...
                                                        <li class="variations_options variations_tab show_if_variable">
                                                            <a href="#variable_product_options"><span>Variations</span></a>
                                                        </li>
                                                        <li class="advanced_options advanced_tab ">
                                                            <a href="#advanced_product_data"><span>Advanced</span></a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div id="general_product_data"
                                                        ...
                                                        <div class="options_group show_if_external">
                                                            <p class="form-field _product_url_field ">
                                                                <label for="_product_url">Product URL</label><input
                                                                        type="text" class="short" style=""
                                                                        name="_product_url" id="_product_url" value=""
                                                                        placeholder="https://"/> <span
                                                                        class="description">Enter the external URL to the product.</span>
                                                            </p>
                                                            <p class="form-field _button_text_field ">
                                                                <label for="_button_text">Button text</label><input
                                                                        type="text" class="short" style=""
                                                                        name="_button_text" id="_button_text" value=""
                                                                        placeholder="Buy product"/> <span
                                                                        class="description">This text will be shown on the button linking to the external product.</span>
                                                            </p></div>
                                                        ...
                                                        <div class="options_group pricing show_if_simple show_if_external hidden">
                                                            ...
                                                            <p class="form-field _sale_price_field ">
                                                                <label for="_sale_price">Sale price
                                                                    (&#036;)</label><input type="text"
                                                                                           class="short wc_input_price"
                                                                                           style="" name="_sale_price"
                                                                                           id="_sale_price" value=""
                                                                                           placeholder=""/> <span
                                                                        class="description"><a href="#"
                                                                                               class="sale_schedule">Schedule</a></span>
                                                            </p>
                                                            <p class="form-field sale_price_dates_fields">
                                                                <label for="_sale_price_dates_from">Sale price
                                                                    dates</label>
                                                                <input type="text" class="short"
                                                                       name="_sale_price_dates_from"
                                                                       id="_sale_price_dates_from" value=""
                                                                       placeholder="From&hellip; YYYY-MM-DD"
                                                                       maxlength="10"
                                                                       pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"/>
                                                                <input type="text" class="short"
                                                                       name="_sale_price_dates_to"
                                                                       id="_sale_price_dates_to" value=""
                                                                       placeholder="To&hellip;  YYYY-MM-DD"
                                                                       maxlength="10"
                                                                       pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"/>
                                                                <a href="#" class="description cancel_sale_schedule">Cancel</a><span
                                                                        class="woocommerce-help-tip" tabindex="0"
                                                                        aria-label="The sale will start at 00:00:00 of &quot;From&quot; date and end at 23:59:59 of &quot;To&quot; date."
                                                                        data-tip="The sale will start at 00:00:00 of &quot;From&quot; date and end at 23:59:59 of &quot;To&quot; date."></span>
                                                            </p></div>
                                                        ...
                                                        <div class="options_group show_if_downloadable hidden">
                                                            <div class="form-field downloadable_files">
                                                                ...
                                                                <table class="widefat">
                                                                    ...
                                                                    <tr>
                                                                        <th class="sort">&nbsp;</th>
                                                                        <th>Name <span class="woocommerce-help-tip"
                                                                                       tabindex="0"
                                                                                       aria-label="This is the name of the download shown to the customer."
                                                                                       data-tip="This is the name of the download shown to the customer."></span>
                                                                        </th>
                                                                        <th colspan="2">File URL <span
                                                                                    class="woocommerce-help-tip"
                                                                                    tabindex="0"
                                                                                    aria-label="This is the URL or absolute path to the file which customers will get access to. URLs entered here should already be encoded."
                                                                                    data-tip="This is the URL or absolute path to the file which customers will get access to. URLs entered here should already be encoded."></span>
                                                                        </th>
                                                                        <th>&nbsp;</th>
                                                                    </tr>
                                                                    </thead>
...
&lt;/tr&gt;
							">Add File</a>
                                                            ...
                                                            <p class="form-field _download_limit_field ">
                                                                <label for="_download_limit">Download
                                                                    limit</label><input type="number" class="short"
                                                                                        style="" name="_download_limit"
                                                                                        id="_download_limit" value=""
                                                                                        placeholder="Unlimited" step="1"
                                                                                        min="0"/> <span
                                                                        class="description">Leave blank for unlimited re-downloads.</span>
                                                            </p>
                                                            <p class="form-field _download_expiry_field ">
                                                                <label for="_download_expiry">Download
                                                                    expiry</label><input type="number" class="short"
                                                                                         style=""
                                                                                         name="_download_expiry"
                                                                                         id="_download_expiry" value=""
                                                                                         placeholder="Never" step="1"
                                                                                         min="0"/> <span
                                                                        class="description">Enter the number of days before a download link expires, or leave blank.</span>
                                                            </p></div>
                                                    ...
                                                    <div id="inventory_product_data"
                                                        ...
                                                        <div class="inline notice woocommerce-message show_if_variable">
                                                            <p>
                                                                Settings below apply to all variations without manual
                                                                stock management enabled. <a target="_blank"
                                                                                             href="https://woocommerce.com/document/variable-product/">Learn
                                                                    more</a>
                                                            </p>
                                                        </div>
                                                        <div class="options_group">
                                                            <p class="form-field _sku_field ">
                                                                <label for="_sku"><abbr
                                                                            title="Stock Keeping Unit">SKU</abbr></label><span
                                                                        class="woocommerce-help-tip" tabindex="0"
                                                                        aria-label="SKU refers to a Stock-keeping unit, a unique identifier for each distinct product and service that can be purchased."
                                                                        data-tip="SKU refers to a Stock-keeping unit, a unique identifier for each distinct product and service that can be purchased."></span><input
                                                                        type="text" class="short" style="" name="_sku"
                                                                        id="_sku" value="" placeholder=""/></p>
                                                            <p class="form-field _manage_stock_field show_if_simple show_if_variable">
                                                                <label for="_manage_stock">Stock
                                                                    management</label><input type="checkbox"
                                                                                             class="checkbox" style=""
                                                                                             name="_manage_stock"
                                                                                             id="_manage_stock"
                                                                                             value="yes"/> <span
                                                                        class="description">Track stock quantity for this product</span>
                                                            </p>
                                                            <div class="stock_fields show_if_simple show_if_variable"><p
                                                                        class="form-field _stock_field ">
                                                                    <label for="_stock">Quantity</label><span
                                                                            class="woocommerce-help-tip" tabindex="0"
                                                                            aria-label="Stock quantity. If this is a variable product this value will be used to control stock for all variations, unless you define stock at variation level."
                                                                            data-tip="Stock quantity. If this is a variable product this value will be used to control stock for all variations, unless you define stock at variation level."></span><input
                                                                            type="number" class="short wc_input_stock"
                                                                            style="" name="_stock" id="_stock" value="1"
                                                                            placeholder="" step="any"/></p><input
                                                                        type="hidden" name="_original_stock" value="0"/>
                                                                <fieldset class="form-field _backorders_field ">
                                                                    <legend>Allow backorders?</legend>
                                                                    <span class="woocommerce-help-tip" tabindex="0"
                                                                          aria-label="If managing stock, this controls whether or not backorders are allowed. If enabled, stock quantity can go below 0."
                                                                          data-tip="If managing stock, this controls whether or not backorders are allowed. If enabled, stock quantity can go below 0."></span>
                                                                    <ul class="wc-radios">
                                                                        <li><label><input
                                                                                        name="_backorders"
                                                                                        value="no"
                                                                        ...
                                                                        <li><label><input
                                                                                ...
                                                                                /> Allow, but notify customer</label>
                                                                        </li>
                                                                        <li><label><input
                                                                                        name="_backorders"
                                                                                        value="yes"
                                                                ...
                                                                <p class="form-field _low_stock_amount_field ">
                                                                    <label for="_low_stock_amount">Low stock
                                                                        threshold</label><span
                                                                            class="woocommerce-help-tip" tabindex="0"
                                                                            aria-label="When product stock reaches this amount you will be notified by email. It is possible to define different values for each variation individually. The shop default value can be set in Settings &gt; Products &gt; Inventory."
                                                                            data-tip="When product stock reaches this amount you will be notified by email. It is possible to define different values for each variation individually. The shop default value can be set in Settings &gt; Products &gt; Inventory."></span><input
                                                                            type="number" class="short" style=""
                                                                            name="_low_stock_amount"
                                                                            id="_low_stock_amount" value=""
                                                                            placeholder="Store-wide threshold (2)"
                                                                            step="any"/></p></div>
                                                            <fieldset
                                                                    class="form-field _stock_status_field stock_status_field hide_if_variable hide_if_external hide_if_grouped">
                                                                <legend>Stock status</legend>
                                                                <span class="woocommerce-help-tip" tabindex="0"
                                                                      aria-label="Controls whether or not the product is listed as &quot;in stock&quot; or &quot;out of stock&quot; on the frontend."
                                                                      data-tip="Controls whether or not the product is listed as &quot;in stock&quot; or &quot;out of stock&quot; on the frontend."></span>
                                                                <ul class="wc-radios">
                                                                    <li><label><input
                                                                                    name="_stock_status"
                                                                                    value="instock"
                                                        ...
                                                        <div class="inventory_sold_individually options_group show_if_simple show_if_variable">
                                                            <p class="form-field _sold_individually_field show_if_simple show_if_variable">
                                                                <label for="_sold_individually">Sold
                                                                    individually</label><input type="checkbox"
                                                                                               class="checkbox" style=""
                                                                                               name="_sold_individually"
                                                                                               id="_sold_individually"
                                                                                               value="yes"/> <span
                                                                        class="description">Limit purchases to 1 item per order</span>
                                                            </p><span class="woocommerce-help-tip" tabindex="0"
                                                                      aria-label="Check to let customers to purchase only 1 item in a single order. This is particularly useful for items that have limited quantity, for example art or handmade goods."
                                                                      data-tip="Check to let customers to purchase only 1 item in a single order. This is particularly useful for items that have limited quantity, for example art or handmade goods."></span>
                                                        </div>
                                                    ...
                                                    <div id="shipping_product_data"
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field _weight_field ">
                                                                <label for="_weight">Weight (kg)</label><span
                                                                        class="woocommerce-help-tip" tabindex="0"
                                                                        aria-label="Weight in decimal form"
                                                                        data-tip="Weight in decimal form"></span><input
                                                                        type="text" class="short wc_input_decimal"
                                                                        style="" name="_weight" id="_weight" value=""
                                                                        placeholder="0"/></p>
                                                            <p class="form-field dimensions_field">
                                                                <label for="product_length">
                                                                    Dimensions (cm) </label>
                                                                <span class="wrap">
					<input id="product_length" placeholder="Length" class="input-text wc_input_decimal" size="6"
                           type="text" name="_length" value=""/>
					<input id="product_width" placeholder="Width" class="input-text wc_input_decimal" size="6"
                           type="text" name="_width" value=""/>
					<input id="product_height" placeholder="Height" class="input-text wc_input_decimal last" size="6"
                           type="text" name="_height" value=""/>
				</span>
                                                                <span class="woocommerce-help-tip" tabindex="0"
                                                                      aria-label="LxWxH in decimal form"
                                                                      data-tip="LxWxH in decimal form"></span></p>
                                                        </div>
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field shipping_class_field">
                                                                ...
                                                                <span class="woocommerce-help-tip" tabindex="0"
                                                                      aria-label="Shipping classes are used by certain shipping methods to group similar products."
                                                                      data-tip="Shipping classes are used by certain shipping methods to group similar products."></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div id="linked_product_data"
                                                        ...
                                                        <div class="options_group show_if_grouped">
                                                            <p class="form-field">
                                                                <label for="grouped_products">Grouped products</label>
                                                                <select class="wc-product-search" multiple="multiple"
                                                                        style="width: 50%;" id="grouped_products"
                                                                        name="grouped_products[]" data-sortable="true"
                                                                        data-placeholder="Search for a product&hellip;"
                                                                        data-action="woocommerce_json_search_products"
                                                                        data-exclude="43">
                                                                </select> <span class="woocommerce-help-tip"
                                                                                tabindex="0"
                                                                                aria-label="This lets you choose which products are part of this group."
                                                                                data-tip="This lets you choose which products are part of this group."></span>
                                                            </p>
                                                        </div>
                                                            ...
                                                            <p class="form-field">
                                                                ...
                                                                <select class="wc-product-search" multiple="multiple"
                                                                        ...
                                                                        data-exclude="43">
                                                                                ...
                                                                                tabindex="0"
                                                                                aria-label="Upsells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive."
                                                                                data-tip="Upsells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive."></span>
                                                            </p>

                                                            <p class="form-field hide_if_grouped hide_if_external">
                                                                <label for="crosssell_ids">Cross-sells</label>
                                                                <select class="wc-product-search" multiple="multiple"
                                                                        style="width: 50%;" id="crosssell_ids"
                                                                        name="crosssell_ids[]"
                                                                        data-placeholder="Search for a product&hellip;"
                                                                        data-action="woocommerce_json_search_products_and_variations"
                                                                        data-exclude="43">
                                                                                ...
                                                                                tabindex="0"
                                                                                aria-label="Cross-sells are products which you promote in the cart, based on the current product."
                                                                                data-tip="Cross-sells are products which you promote in the cart, based on the current product."></span>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div id="product_attributes"
                                                        ...
                                                        <div class="toolbar toolbar-top">
                                                            <div id="message" class="inline notice woocommerce-message">
                                                                <p>
                                                                    Add descriptive pieces of information that customers
                                                                    can use to search for this product on your store,
                                                                    such as “Material” or “Brand”. </p>
                                                            </div>
			...
			<a href="#" class="expand_all">Expand</a> / <a href="#" class="close_all">Close</a>
                                                            ...
                                                            <div class="actions">
                                                                <button type="button"
                                                                        class="button add_custom_attribute">Add new
                                                                </button>
                                                                <select class="wc-attribute-search"
                                                                        data-placeholder="Add existing"
		...
		<span class="expand-close">
			<a href="#" class="expand_all">Expand</a> / <a href="#" class="close_all">Close</a>
                                                            ...
                                                            <button type="button" aria-disabled="true"
                                                                    class="button save_attributes button-primary disabled">
                                                                Save attributes
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div id="advanced_product_data"
                                                         class="panel woocommerce_options_panel hidden">

                                                        <div class="options_group hide_if_external hide_if_grouped">
                                                            <p class="form-field _purchase_note_field ">
                                                                <label for="_purchase_note">Purchase note</label><span
                                                                        class="woocommerce-help-tip" tabindex="0"
                                                                        aria-label="Enter an optional note to send the customer after purchase."
                                                                        data-tip="Enter an optional note to send the customer after purchase."></span><textarea
                                                                        class="short" style="" name="_purchase_note"
                                                                        id="_purchase_note" placeholder="" rows="2"
                                                                        cols="20"></textarea></p></div>

                                                        <div class="options_group">
                                                            <p class="form-field menu_order_field ">
                                                                <label for="menu_order">Menu order</label><span
                                                                        class="woocommerce-help-tip" tabindex="0"
                                                                        aria-label="Custom ordering position."
                                                                        data-tip="Custom ordering position."></span><input
                                                                        type="number" class="short" style=""
                                                                        name="menu_order" id="menu_order" value="0"
                                                                        placeholder="" step="1"/></p></div>

                                                        <div class="options_group reviews">
                                                            <p class="form-field comment_status_field ">
                                                                <label for="comment_status">Enable reviews</label><input
                                                                        type="checkbox" class="checkbox" style=""
                                                                        name="comment_status" id="comment_status"
                                                                        value="open" checked='checked'/></p></div>
                                                        ...
                                                        <div id="variable_product_options_inner">
                                                            ...
                                                            <div class="add-attributes-container">
                                                                <div class="add-attributes-message">
                                                                    ...
                                                                    <p>
                                                                        Add some attributes in the <a
                                                                                class="variations-add-attributes-link"
                                                                                href="#product_attributes">Attributes</a>
                                                                        tab to generate variations. Make sure to check
                                                                        the <b>Used for variations</b> box. <a
                                                                                class="variations-learn-more-link"
                                                                                href="https://woocommerce.com/document/variable-product/"
                                                                                target="_blank" rel="noreferrer">Learn
                                                                            more</a></p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <script type="text/template"
                                                            id="tmpl-wc-modal-set-price-variations">
                                                        <div class="wc-backbone-modal">
                                                            <div class="wc-backbone-modal-content">
                                                                <div class="components-modal__content woocommerce-set-price-variations"
                                                                     role="document">
                                                                    <div class="components-modal__header">
                                                                        <h2>Wordpress says</h2>
                                                                    </div>
                                                                    <div class="woocommerce-usage-modal__wrapper">
                                                                        <div class="woocommerce-usage-modal__message">
                                                                            <span>Add price to all variations that don&#039;t have a price (&#036; USD)</span>
                                                                            <input type="text"
                                                                                   class="components-text-control__input wc_input_variations_price"/>
                                                                        </div>
                                                                        <div class="woocommerce-usage-modal__actions">
                                                                            <button class="modal-close components-button is-secondary">
                                                                                Cancel
                                                                            </button>
                                                                            <button class="modal-close button components-button add_variations_price_button button-primary"
                                                                                    disabled>Add prices
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div id="slugdiv" class="postbox  hide-if-js">
                                            <div class="postbox-header"><h2 class="hndle">Đường dẫn</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                class="order-higher-indicator"
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden" id="slugdiv-handle-order-higher-description">Chuyển Đường dẫn lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden" id="slugdiv-handle-order-lower-description">Chuyển Đường dẫn xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Đường dẫn</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="inside">
                                                <label class="screen-reader-text" for="post_name">
                                                    Đường dẫn</label><input name="post_name" type="text"
                                                                            class="large-text" id="post_name" value=""/>
                                            </div>
                                        </div>
                                        <div id="postexcerpt" class="postbox ">
                                            <div class="postbox-header"><h2 class="hndle">Product short description</h2>
                                                <div class="handle-actions hide-if-no-js">
                                                    <button type="button" class="handle-order-higher"
                                                            aria-disabled="false"
                                                        ...
                                                        <span class="screen-reader-text">Di chuyển lên</span><span
                                                                ...
                                                                aria-hidden="true"></span></button>
                                                    <span class="hidden"
                                                          id="postexcerpt-handle-order-higher-description">Chuyển Product short description lên trên</span>
                                                    <button type="button" class="handle-order-lower"
                                                            aria-disabled="false"
                                                    ...
                                                    <span class="hidden"
                                                          id="postexcerpt-handle-order-lower-description">Chuyển Product short description xuống dưới</span>
                                                    <button type="button" class="handlediv" aria-expanded="true"><span
                                                                class="screen-reader-text">Chuyển đổi bảng điều khiển: Product short description</span><span
                                                                class="toggle-indicator" aria-hidden="true"></span>
                                                    </button>
                                                </div>
                                            </div>
                                                ...
                                                <div id="wp-excerpt-wrap" class="wp-core-ui wp-editor-wrap tmce-active">
                                                        ...
                                                        <div id="wp-excerpt-media-buttons" class="wp-media-buttons">
                                                            <button type="button" class="button insert-media add_media"
                                                                    data-editor="excerpt"><span
                                                                        class="wp-media-buttons-icon"></span> Thêm Media
                                                            </button>
                                                        </div>
                                                        <div class="wp-editor-tabs">
                                                            <button type="button" id="excerpt-tmce"
                                                                    class="wp-switch-editor switch-tmce"
                                                                    data-wp-editor-id="excerpt">Trực quan
                                                            </button>
                                                            <button type="button" id="excerpt-html"
                                                                    class="wp-switch-editor switch-html"
                                                                    data-wp-editor-id="excerpt">Văn bản
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div id="wp-excerpt-editor-container" class="wp-editor-container">
                                                        ...
                                                        <textarea class="wp-editor-area" rows="20" autocomplete="off"
                                                                  cols="40" name="excerpt" id="excerpt"></textarea>
                                                    </div>
                                                </div>
                        ...
                        <tr id="replyrow" class="inline-edit-row" style="display:none;">
                            <td colspan="2" class="colspanchange">
                                <fieldset class="comment-reply">
                                    <legend>
                                        <span class="hidden" id="editlegend">Sửa phản hồi</span>
                                    ...
                                    <input type="hidden" id="_ajax_nonce-replyto-comment"
                                           name="_ajax_nonce-replyto-comment" value="3365c67175"/><input type="hidden"
        ...
        <div id="wp-acf_content-wrap" class="wp-core-ui wp-editor-wrap tmce-active">
            <div id="wp-acf_content-editor-tools" class="wp-editor-tools hide-if-no-js">
                <div id="wp-acf_content-media-buttons" class="wp-media-buttons">
                    <button type="button" class="button insert-media add_media" data-editor="acf_content"><span
                                class="wp-media-buttons-icon"></span> Thêm Media
                    </button>
                </div>
                <div class="wp-editor-tabs">
                    <button type="button" id="acf_content-tmce" class="wp-switch-editor switch-tmce"
                            data-wp-editor-id="acf_content">Trực quan
                    </button>
                    <button type="button" id="acf_content-html" class="wp-switch-editor switch-html"
                            data-wp-editor-id="acf_content">Văn bản
                    </button>
                </div>
            </div>
        ...
        <div class="uploader-inline-content ">
            ...
            <div class="post-upload-ui" id="post-upload-info">
                ...
                <p class="suggested-dimensions">
                    Kích thước ảnh để nghị: x pixels. </p>
                <# } #>
    ...
    <script type="text/html" id="tmpl-attachment-details-two-column">
        <div class="attachment-media-view ">
            ...
            <div class="thumbnail thumbnail-">
                ...
                <img class="details-image icon" src="" draggable="false" alt=""/>
                <# } #>
                ...
                <div style="" class="wp-media-wrapper wp-video">
                    ...
                    <# if ( data.image && data.image.src !== data.icon ) { #>poster=""<# } #>>
                    <source type="" src=""/>
                    </video>
                </div>
                <# } #>
        ...
        <div class="attachment-info">
            ...
            <div class="details">
                <h2 class="screen-reader-text">
                    Chi tiết </h2>
                <div class="uploaded"><strong>Đã tải lên vào lúc:</strong></div>
                ...
                <# } #>
                <div class="filename"><strong>Tên tập tin:</strong></div>
                <div class="file-type"><strong>Loại tập tin:</strong></div>
                <div class="file-size"><strong>Dung lượng tệp:</strong></div>
                ...
                <# if ( data.mediaStates ) { #>
                <div class="media-states"><strong>Được dùng như:</strong></div>
                <# } #>
            ...
            <div class="settings">
                ...
                <span class="setting" data-setting="artist">
					...
					<input type="text" id="attachment-details-two-column-artist" value=""/>
				</span>
                <span class="setting" data-setting="album">
					<label for="attachment-details-two-column-album" class="name">Album</label>
					<input type="text" id="attachment-details-two-column-album" value=""/>
				</span>
                <# } #>
            ...
            <div class="actions">
                <# if ( data.link ) { #>
                <a class="view-attachment" href="">Xem trang đính kèm</a>
                <# } #>
                <# if ( data.can.save ) { #>
                <# if ( data.link ) { #>
                <span class="links-separator">|</span>
                <# } #>
                <a href="">Chỉnh sửa chi tiết hơn</a>
                <# } #>
    ...
    <script type="text/html" id="tmpl-attachment">
        <div class="attachment-preview js--select-attachment type- subtype- ">
            <div class="thumbnail">
                <# if ( data.uploading ) { #>
                <div class="media-progress-bar">
                    <div style="width: %"></div>
        ...
        if ( data.describe ) {
        if ( 'image' === data.type ) { #>
        <input type="text" value="" class="describe" data-setting="caption"
               aria-label="Chú thích"
               placeholder="Chú thích&hellip;"/>
        <# } else { #>
        <input type="text" value="" class="describe" data-setting="title"
        <# if ( 'video' === data.type ) { #>
    ...
    <script type="text/html" id="tmpl-attachment-details">
        ...
        <div class="attachment-info">
            ...
            <div class="details">
                ...
                <a class="edit-attachment" href="&amp;image-editor" target="_blank">Sửa ảnh</a>
                <# } #>
                <# } #>

                <# if ( data.fileLength && data.fileLengthHumanReadable ) { #>
                <div class="file-length">Độ dài: <span aria-hidden="true"></span>
                    <span class="screen-reader-text"></span>
                </div>
                <# } #>
        ...
        <span class="setting" data-setting="title">
			...
			<input type="text" id="attachment-details-title" value=""/>
		</span>
        <# if ( 'audio' === data.type ) { #>
        <span class="setting" data-setting="artist">
			<label for="attachment-details-artist" class="name">Nghệ sĩ</label>
			<input type="text" id="attachment-details-artist" value=""/>
		</span>
        <span class="setting" data-setting="album">
			<label for="attachment-details-album" class="name">Album</label>
			<input type="text" id="attachment-details-album" value=""/>
		</span>
        <# } #>
        <span class="setting" data-setting="caption">
        ...
        <span class="setting" data-setting="url">
			...
			<input type="text" class="attachment-details-copy-link" id="attachment-details-copy-link" value=""
                   readonly/>
        ...
        <div class="media-embed media-embed-details">
            <div class="embed-media-settings embed-audio-settings">
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-source" readonly data-setting="src" value=""/>
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-mp3-source" readonly data-setting="mp3" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn audio</button>
				</span>
                <# } #>
                <# if ( ! _.isEmpty( data.model.ogg ) ) {
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-ogg-source" readonly data-setting="ogg" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn audio</button>
				</span>
                <# } #>
                <# if ( ! _.isEmpty( data.model.flac ) ) {
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-flac-source" readonly data-setting="flac" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn audio</button>
				</span>
                <# } #>
                <# if ( ! _.isEmpty( data.model.m4a ) ) {
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-m4a-source" readonly data-setting="m4a" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn audio</button>
				</span>
                <# } #>
                <# if ( ! _.isEmpty( data.model.wav ) ) {
                ...
                <span class="setting">
					...
					<input type="text" id="audio-details-wav-source" readonly data-setting="wav" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn audio</button>
				</span>
                <# } #>
                ...
                <fieldset class="setting-group">
                    ...
                    <span class="setting">
						...
						<# _.each( html5types, function (mime, type) { #>
							<button class="button add-media-source" data-mime=""></button>
						<# } ) #>
						</span>
					</span>
                </fieldset>
        ...
        <div class="media-embed media-embed-details">
            <div class="embed-media-settings embed-video-settings">
                <div class="wp-video-holder">
					...
					<input type="text" id="video-details-source" readonly data-setting="src" value=""/>
					...
					<input type="text" id="video-details-mp4-source" readonly data-setting="mp4" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn video</button>
				</span>
                    <# } #>
					...
					<input type="text" id="video-details-m4v-source" readonly data-setting="m4v" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn video</button>
				</span>
                    <# } #>
					...
					<input type="text" id="video-details-webm-source" readonly data-setting="webm" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn video</button>
				</span>
                    <# } #>
					...
					<input type="text" id="video-details-ogv-source" readonly data-setting="ogv" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn video</button>
				</span>
                    <# } #>
					...
					<input type="text" id="video-details-flv-source" readonly data-setting="flv" value=""/>
					<button type="button" class="button-link remove-setting">Loại bỏ nguồn video</button>
				</span>
                    <# } #>
                </div>
                ...
                <span class="setting">
					...
					<input type="text" id="video-details-poster-image" readonly data-setting="poster" value=""/>
                ...
                <span class="setting" data-setting="content">
					...
					if ( ! _.isEmpty( data.model.content ) ) {
						...
						<label for="video-details-track-" class="name">Bài hát (phụ đề, chú thích, mô tả, chương, hoặc siêu dữ liệu)</label>
						<input class="content-track" type="text" id="video-details-track-"
                               aria-describedby="video-details-track-desc-" value=""/>
						<span class="description" id="video-details-track-desc-">
    ...
    <script type="text/html" id="tmpl-crop-content">
        <img class="crop-image" src="" alt="Xem trước vùng cắt hình ảnh khu vực. Yêu cầu tương tác với chuột."/>
        <div class="upload-errors"></div>
    </script>
    ...
    <script type="text/html" id="tmpl-site-icon-preview">
        ...
        <div class="favicon-preview">
            ...
            <div class="favicon">
                <img id="preview-favicon" src="" alt="Xem trước biểu tượng trình duyệt"/>
            </div>
        ...
        <div class="app-icon-preview">
            <img id="preview-app-icon" src="" alt="Xem trước biểu tượng ứng dụng"/>
        </div>
    </script>
    ...
    <div id="local-storage-notice" class="hidden notice is-dismissible">
        <p class="local-restore">
            ...
            <button type="button" class="button restore-backup">Khôi phục bản sao lưu</button>
        </p>
        <p class="help">
            Việc này sẽ thay thế nội dung hiện tại với bản sao lưu gần nhất. Bạn có thể khôi phục lại và tiếp tục trong
            bộ soạn thảo để có nội dung cũ hoặc trở về phiên bản được lưu trữ. </p>
    </div>
        ...
        window.wcTracks.recordEvent = function (name, properties) {
            ...
            eventProperties = {
                ...eventProperties, ...{
                    ...
                    "_dr": "http:\/\/localhost\/wordpress\/wp-admin\/edit.php?post_type=product",
                    "_dl": "http:\/\/localhost\/wordpress\/wp-admin\/post-new.php?post_type=product",
    ...
    <script src='http://localhost/wordpress/wp-includes/js/autosave.min.js?ver=6.2.2' id='autosave-js'></script>
    <script src='http://localhost/wordpress/wp-includes/js/jquery/suggest.min.js?ver=1.1-20110113'
            id='suggest-js'></script>
    ...
    <script src='http://localhost/wordpress/wp-includes/js/jquery/jquery.color.min.js?ver=2.2.0'
        ...
        (function (domain, translations) {
            ...
            "locale_data": {
                "messages": {
                    ...
                    "Drag boxes here": ["K\u00e9o c\u00e1c m\u1ee5c v\u00e0o \u0111\u00e2y"],
                    "Add boxes from the Screen Options menu": ["Th\u00eam m\u1ee5c t\u1eeb menu C\u00e0i \u0111\u1eb7t m\u00e0n h\u00ecnh"],
                    "The boxes order has been saved.": ["Th\u1ee9 t\u1ef1 c\u00e1c m\u1ee5c \u0111\u00e3 \u0111\u01b0\u1ee3c l\u01b0u l\u1ea1i."],
                    "The box is on the last position": ["M\u1ee5c n\u1eb1m \u1edf v\u1ecb tr\u00ed cu\u1ed1i c\u00f9ng"],
                    "The box is on the first position": ["M\u1ee5c n\u1eb1m \u1edf v\u1ecb tr\u00ed tr\u00ean c\u00f9ng"]
                }
            },
            "comment": {"reference": "wp-admin\/js\/postbox.js"}
        });
    </script>
    <script src='http://localhost/wordpress/wp-admin/js/postbox.min.js?ver=6.2.2' id='postbox-js'></script>
        ...
        (function (domain, translations) {
            ...
            "locale_data": {
                "messages": {
                    ...
                    "Term selected.": ["Term \u0111\u00e3 \u0111\u01b0\u1ee3c ch\u1ecdn."],
                    "tag delimiter\u0004,": [","]
                }
            },
            "comment": {"reference": "wp-admin\/js\/tags-suggest.js"}
        });
    </script>
    <script src='http://localhost/wordpress/wp-admin/js/tags-suggest.min.js?ver=6.2.2' id='tags-suggest-js'></script>
    <script id='tags-box-js-translations'>
        (function (domain, translations) {
            var localeData = translations.locale_data[domain] || translations.locale_data.messages;
            localeData[""].domain = domain;
            wp.i18n.setLocaleData(localeData, domain);
            ...
            "locale_data": {
                "messages": {
                    ...
                    "Term added.": ["Term \u0111\u00e3 \u0111\u01b0\u1ee3c th\u00eam."],
                    "Term removed.": ["Term \u0111\u00e3 b\u1ecb xo\u00e1."],
                    "Remove term:": ["Xo\u00e1 term:"],
                    "tag delimiter\u0004,": [","]
                }
            },
            "comment": {"reference": "wp-admin\/js\/tags-box.js"}
        });
    </script>
    <script src='http://localhost/wordpress/wp-admin/js/tags-box.min.js?ver=6.2.2' id='tags-box-js'></script>
    <script id='word-count-js-extra'>
        var wordCountL10n = {
            "type": "words",
            "shortcodes": ["wp_caption", "caption", "gallery", "playlist", "audio", "video", "embed", "acf", "product", "product_page", "product_category", "product_categories", "add_to_cart", "add_to_cart_url", "products", "recent_products", "sale_products", "best_selling_products", "top_rated_products", "featured_products", "product_attribute", "related_products", "shop_messages", "woocommerce_order_tracking", "woocommerce_cart", "woocommerce_checkout", "woocommerce_my_account", "woocommerce_messages"]
        };
    </script>
    <script src='http://localhost/wordpress/wp-admin/js/word-count.min.js?ver=6.2.2' id='word-count-js'></script>
    <script src='http://localhost/wordpress/wp-includes/js/wp-sanitize.min.js?ver=6.2.2' id='wp-sanitize-js'></script>
    <script src='http://localhost/wordpress/wp-includes/js/clipboard.min.js?ver=2.0.11' id='clipboard-js'></script>
    <script id='post-js-translations'>
        (function (domain, translations) {
            var localeData = translations.locale_data[domain] || translations.locale_data.messages;
            localeData[""].domain = domain;
            wp.i18n.setLocaleData(localeData, domain);
            ...
            "locale_data": {
                "messages": {
                    "": {"domain": "messages", "plural-forms": "nplurals=1; plural=0;", "lang": "vi_VN"},
                    "Permalink saved": ["Li\u00ean k\u1ebft \u0111\u00e3 \u0111\u01b0\u1ee3c l\u01b0u"],
                    "Published on:": ["\u0110\u00e3 \u0111\u0103ng v\u00e0o:"],
                    "Publish on:": ["\u0110\u0103ng v\u00e0o:"],
                    "Schedule for:": ["\u0110\u00e3 l\u00ean l\u1ecbch cho:"],
                    "Saving Draft\u2026": ["\u0110ang l\u01b0u b\u1ea3n nh\u00e1p..."],
                    "No more comments found.": ["Kh\u00f4ng t\u00ecm th\u1ea5y b\u00ecnh lu\u1eadn n\u00e0o n\u1eefa."],
                    "Show more comments": ["Xem th\u00eam b\u00ecnh lu\u1eadn"],
                    "post action\/button label\u0004Schedule": ["D\u1ef1 ki\u1ebfn"],
                    "%1$s %2$s, %3$s at %4$s:%5$s": ["%1$s %2$s, %3$s v\u00e0o l\u00fac %4$s:%5$s"],
                    "Public, Sticky": ["C\u00f4ng khai, Ch\u00fa \u00fd"],
                    "Privately Published": ["\u0110\u01b0\u1ee3c \u0111\u0103ng \u1edf ch\u1ebf \u0111\u1ed9 ri\u00eang t\u01b0"],
                    "Save as Pending": ["L\u01b0u v\u00e0o Ch\u1edd duy\u1ec7t"],
                    "The file URL has been copied to your clipboard": ["URL c\u1ee7a file \u0111\u00e3 \u0111\u01b0\u1ee3c sao ch\u00e9p v\u00e0o b\u1ed9 nh\u1edb t\u1ea1m"],
                    "The changes you made will be lost if you navigate away from this page.": ["C\u00e1c thay \u0111\u1ed5i b\u1ea1n v\u1eeba th\u1ef1c hi\u1ec7n s\u1ebd b\u1ecb m\u1ea5t n\u1ebfu b\u1ea1n \u0111i kh\u1ecfi trang n\u00e0y khi ch\u01b0a l\u01b0u b\u00e0i."],
    ...
    <script src='http://localhost/wordpress/wp-admin/js/post.min.js?ver=6.2.2' id='post-js'></script>
    <script src='http://localhost/wordpress/wp-admin/js/editor-expand.min.js?ver=6.2.2' id='editor-expand-js'></script>
    <script id='thickbox-js-extra'>
        var thickboxL10n = {
            ...
            "loadingAnimation": "http:\/\/localhost\/wordpress\/wp-includes\/js\/thickbox\/loadingAnimation.gif"
        };
    </script>
    <script src='http://localhost/wordpress/wp-includes/js/thickbox/thickbox.js?ver=3.1-20121105'
    ...
    <script id='media-views-js-extra'>
        var _wpMediaViewsL10n = {
            ...
            "settings": {
                ...
                "post": {"id": 43, "nonce": "9ee06bd7b6", "featuredImageId": -1},
    ...
    <script src='http://localhost/wordpress/wp-content/plugins/woocommerce/assets/client/admin/wp-admin-scripts/variable-product-tour.js?ver=7.9.0'
            id='wc-admin-variable-product-tour-js'></script>
    <script id='wc-admin-product-tracking-js-extra'>
        var productScreen = {"name": "new"};
    </script>
    ...
    <script id='quicktags-js-extra'>
        var quicktagsL10n = {
            "closeAllOpenTags": "\u0110\u00f3ng t\u1ea5t c\u1ea3 c\u00e1c th\u1ebb",
            "closeTags": "\u0111\u00f3ng th\u1ebb",
            "enterURL": "\u0110i\u1ec1n \u0111\u01b0\u1eddng d\u1eabn",
            "enterImageURL": "\u0110i\u1ec1n \u0111\u01b0\u1eddng d\u1eabn c\u1ee7a \u1ea3nh",
            "enterImageDescription": "\u0110i\u1ec1n m\u00f4 t\u1ea3 c\u1ee7a \u1ea3nh",
            "textdirection": "h\u01b0\u1edbng \u0111\u1ecdc v\u0103n b\u1ea3n",
            "toggleTextdirection": "Chuy\u1ec3n \u0111\u1ed5i h\u01b0\u1edbng \u0111\u1ecdc v\u0103n b\u1ea3n c\u1ee7a b\u1ed9 so\u1ea1n th\u1ea3o",
            "dfw": "Ch\u1ebf \u0111\u1ed9 vi\u1ebft ch\u1ed1ng xao nh\u00e3ng",
            "strong": "\u0110\u1eadm",
            "strongClose": "\u0110\u00f3ng nh\u00e3n \u0111\u1eadm",
            "em": "Nghi\u00eang",
            "emClose": "\u0110\u00f3ng nh\u00e3n nghi\u00eang",
            "link": "Th\u00eam \u0111\u01b0\u1eddng d\u1eabn",
            "blockquote": "Tr\u00edch d\u1eabn",
            "blockquoteClose": "\u0110\u00f3ng nh\u00e3n d\u1ea5u nh\u00e1y k\u00e9p",
            "del": "V\u0103n b\u1ea3n \u0111\u00e3 x\u00f3a (g\u1ea1ch ngang gi\u1eefa ch\u1eef)",
            "delClose": "\u0110\u00f3ng nh\u00e3n v\u0103n b\u1ea3n \u0111\u00e3 x\u00f3a",
            "ins": "V\u0103n b\u1ea3n \u0111\u00e3 ch\u00e8n",
            "insClose": "\u0110\u00f3ng th\u1ebb v\u0103n b\u1ea3n \u0111\u00e3 ch\u00e8n",
            "image": "Ch\u00e8n \u1ea3nh",
            "ul": "Danh s\u00e1ch li\u1ec7t k\u00ea \u0111\u01b0\u1ee3c \u0111\u00e1nh s\u1ed1",
            "ulClose": "\u0110\u00f3ng nh\u00e3n danh s\u00e1ch \u0111\u01b0\u1ee3c k\u00ed hi\u1ec7u",
            "ol": "Danh s\u00e1ch \u0111\u01b0\u1ee3c \u0111\u00e1nh s\u1ed1",
            "olClose": "\u0110\u00f3ng nh\u00e3n danh s\u00e1ch \u0111\u01b0\u1ee3c \u0111\u00e1nh s\u1ed1",
            "li": "M\u1ee5c danh s\u00e1ch",
            "liClose": "\u0110\u00f3ng nh\u00e3n m\u1ee5c danh s\u00e1ch",
            "code": "M\u00e3",
            "codeClose": "\u0110\u00f3ng nh\u00e3n m\u00e3",
            "more": "Ch\u00e8n th\u1ebb \u0110\u1ecdc Th\u00eam"
        };
    </script>
    <script src='http://localhost/wordpress/wp-includes/js/quicktags.min.js?ver=6.2.2' id='quicktags-js'></script>
    <script id='wplink-js-extra'>
        var wpLinkL10n = {
            "title": "Th\u00eam\/S\u1eeda \u0111\u01b0\u1eddng d\u1eabn",
            "update": "C\u1eadp nh\u1eadt",
            "save": "Th\u00eam li\u00ean k\u1ebft",
            "noTitle": "(kh\u00f4ng c\u00f3 ti\u00eau \u0111\u1ec1)",
            "noMatchesFound": "Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3.",
            "linkSelected": "\u0110\u00e3 ch\u1ecdn li\u00ean k\u1ebft.",
    ...
    <script src='http://localhost/wordpress/wp-admin/js/media-upload.min.js?ver=6.2.2' id='media-upload-js'></script>
    <script src='http://localhost/wordpress/wp-includes/js/wp-embed.min.js?ver=6.2.2' id='wp-embed-js'></script>
    <script>
        acf.data = {
            "toolbars": {
                "full": {
                ...
                "basic": {"1": "bold,italic,underline,blockquote,strikethrough,bullist,numlist,alignleft,aligncenter,alignright,undo,redo,link,fullscreen"}
            },
            "select2L10n": {
        ...
        tinyMCEPreInit = {
            ...
            dragDropUpload: true, mceInit: {
                'content': {
                    ...
                    content_css: "http://localhost/wordpress/wp-includes/css/dashicons.min.css?ver=6.2.2,http://localhost/wordpress/wp-includes/js/tinymce/skins/wordpress/wp-content.css?ver=6.2.2,http://localhost/wordpress/wp-content/themes/twentytwentyone/./assets/css/style-editor.css",
                    ...
                    body_class: "content post-type-product post-status-auto-draft page-template-default locale-vi",
                    ...
                    body_class: "excerpt post-type-product post-status-auto-draft page-template-default locale-vi",
                    ...
                    toolbar4: "",
                    tabfocus_elements: ":prev,:next",
                    body_class: "acf_content post-type-product post-status-auto-draft page-template-default locale-vi"
                }
            },
            qtInit: {
                'content': {
                ...
                'acf_content': {id: "acf_content", buttons: "strong,em,link,block,del,ins,img,ul,ol,li,code,more,close"}
            },
            ref: {
                plugins: "charmap,colorpicker,hr,lists,media,paste,tabfocus,textcolor,fullscreen,wordpress,wpautoresize,wpeditimage,wpemoji,wpgallery,wplink,wpdialogs,wptextpattern,wpview",
                theme: "modern",
    ...
    <script src='http://localhost/wordpress/wp-includes/js/tinymce/wp-tinymce.js?ver=49110-20201110'
    ...
    <script type='text/javascript'>
        tinymce.addI18n('vi', {
            ...
            "Blockquote": "Tr\u00edch d\u1eabn",
            "Pre": "Tr\u01b0\u1edbc",
            "Preformatted": "\u0110\u01b0\u1ee3c \u0111\u1ecbnh d\u1ea1ng tr\u01b0\u1edbc",
            "Address": "\u0110\u1ecba ch\u1ec9",
            "Inline": "Thu\u1ed9c c\u00f9ng m\u1ed9t d\u00f2ng",
            "Underline": "G\u1ea1ch ch\u00e2n",
            "Strikethrough": "G\u1ea1ch gi\u1eefa t\u1eeb",
            ...
            "Undo": "L\u00f9i l\u1ea1i",
            "Redo": "L\u00e0m l\u1ea1i b\u01b0\u1edbc v\u1eeba r\u1ed3i",
            "Cancel": "H\u1ee7y",
            "Close": "\u0110\u00f3ng",
            "Visual aids": "H\u00ecnh minh h\u1ecda",
            "Bullet list": "Danh s\u00e1ch li\u1ec7t k\u00ea \u0111\u01b0\u1ee3c \u0111\u00e1nh s\u1ed1",
            "Numbered list": "Danh s\u00e1ch \u0111\u01b0\u1ee3c \u0111\u00e1nh s\u1ed1",
            "Square": "Vu\u00f4ng",
            "Default": "M\u1eb7c \u0111\u1ecbnh",
            "Circle": "V\u00f2ng tr\u00f2n",
            "Disc": "\u0110\u0129a",
            "Lower Greek": "Ki\u1ec3u ch\u1eef Greek th\u01b0\u1eddng",
            "Lower Alpha": "Ki\u1ec3u ch\u1eef Alpha th\u01b0\u1eddng",
            "Upper Alpha": "Ki\u1ec3u ch\u1eef Alpha hoa",
            "Upper Roman": "Roman in hoa",
            "Lower Roman": "Roman th\u01b0\u1eddng",
            "Name": "T\u00ean",
            ...
            "Source": "Ngu\u1ed3n",
            "Border": "Vi\u1ec1n",
            "Constrain proportions": "Gi\u1eef t\u1ec9 l\u1ec7 g\u1ed1c",
            "Vertical space": "Kho\u1ea3ng tr\u1ed1ng chi\u1ec1u d\u1ecdc",
            "Image description": "M\u00f4 t\u1ea3 v\u1ec1 \u1ea3nh",
            "Dimensions": "K\u00edch th\u01b0\u1edbc",
            "Insert image": "Ch\u00e8n \u1ea3nh",
            "Date\/time": "Ng\u00e0y\/gi\u1edd",
            "Insert date\/time": "Th\u00eam ng\u00e0y\/gi\u1edd",
            "Table of Contents": "M\u1ee5c l\u1ee5c",
            "Insert\/Edit code sample": "Ch\u00e8n \/ ch\u1ec9nh s\u1eeda code m\u1eabu",
            "Language": "Ng\u00f4n ng\u1eef",
            "Insert\/edit media": "Ch\u00e8n \/s\u1eeda t\u1eadp tin \u0111a ph\u01b0\u01a1ng ti\u1ec7n",
            "Poster": "\u00c1p ph\u00edch",
            ...
            "Nonbreaking space": "Kh\u00f4ng gi\u00e3n d\u00f2ng",
            "Page break": "Ng\u1eaft trang",
            ...
            "Horizontal space": "Kho\u1ea3ng tr\u1ed1ng chi\u1ec1u ngang",
            "Restore last draft": "Kh\u00f4i ph\u1ee5c l\u1ea1i b\u1ea3n nh\u00e1p cu\u1ed1i",
            "Insert\/edit link": "Th\u00eam\/S\u1eeda \u0111\u01b0\u1eddng d\u1eabn",
            "Remove link": "X\u00f3a \u0111\u01b0\u1eddng d\u1eabn",
            "Link": "Li\u00ean k\u1ebft",
            "Insert link": "Th\u00eam \u0111\u01b0\u1eddng d\u1eabn",
            "Target": "M\u1ee5c ti\u00eau",
            "New window": "C\u1eeda s\u1ed5 m\u1edbi",
            "Text to display": "Ch\u1eef \u0111\u1ec3 hi\u1ec3n th\u1ecb",
            "Url": "URL",
            "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?": "\u0110\u01b0\u1eddng d\u1eabn b\u1ea1n v\u1eeba nh\u1eadp c\u00f3 th\u1ec3 l\u00e0 m\u1ed9t \u0111\u1ecba ch\u1ec9 email, b\u1ea1n c\u00f3 mu\u1ed1n th\u00eam ti\u1ec1n t\u1ed1 mailto: kh\u00f4ng?",
            "The URL you entered seems to be an external link. Do you want to add the required http:\/\/ prefix?": "\u0110\u01b0\u1eddng d\u1eabn b\u1ea1n v\u1eeba nh\u1eadp c\u00f3 th\u1ec3 l\u00e0 m\u1ed9t li\u00ean k\u1ebft t\u1edbi trang kh\u00e1c. B\u1ea1n c\u00f3 mu\u1ed1n th\u00eam ti\u1ec1n t\u1ed1 http:\/\/ kh\u00f4ng?",
            "Color": "M\u00e0u s\u1eafc",
            "Custom color": "M\u00e0u t\u00f9y ch\u1ec9nh",
            "Custom...": "T\u00f9y ch\u1ec9nh...",
            "No color": "Kh\u00f4ng m\u00e0u",
            "Could not find the specified string.": "Kh\u00f4ng th\u1ec3 t\u00ecm th\u1ea5y chu\u1ed7i quy \u0111\u1ecbnh.",
            "Replace": "Thay th\u1ebf",
            "Next": "Ti\u1ebfp theo",
            "Prev": "Tr\u01b0\u1edbc",
            ...
            "Table properties": "T\u00f9y ch\u1ecdn hi\u1ec3n th\u1ecb b\u1ea3ng",
            "Row properties": "Sao ch\u00e9p d\u00f2ng",
            "Cell properties": "Sao ch\u00e9p d\u00f2ng",
            "Border color": "M\u00e0u vi\u1ec1n",
            "Row": "D\u00f2ng",
            "Rows": "D\u00f2ng",
            "Column": "C\u1ed9t",
            ...
            "Insert column before": "Th\u00eam c\u1ed9t v\u00e0o tr\u01b0\u1edbc",
            "Insert column after": "Th\u00eam c\u1ed9t v\u00e0o sau",
            "Paste row before": "D\u00e1n v\u00e0o tr\u01b0\u1edbc d\u00f2ng",
            "Paste row after": "D\u00e1n v\u00e0o sau d\u00f2ng",
            "Delete row": "X\u00f3a d\u00f2ng",
            "Delete column": "X\u00f3a c\u1ed9t",
            "Cut row": "C\u1eaft d\u00f2ng",
            "Copy row": "Sao ch\u00e9p d\u00f2ng",
            "Merge cells": "G\u1ed9p c\u1ed9t",
            "Split cell": "Chia \u00f4 trong b\u1ea3ng",
            "Height": "Cao",
            "Width": "R\u1ed9ng",
            "Caption": "Ch\u00fa th\u00edch",
            "Alignment": "C\u0103n ch\u1ec9nh",
            ...
            "Cell spacing": "Kho\u1ea3ng c\u00e1ch vi\u1ec1n \u00f4",
            "Scope": "Ph\u1ea1m vi",
            "Insert template": "Ch\u00e8n m\u1eabu",
            "Templates": "C\u00e1c m\u1eabu",
            "Background color": "M\u00e0u n\u1ec1n",
            "Text color": "M\u00e0u ch\u1eef v\u0103n b\u1ea3n",
            "Show blocks": "Hi\u1ec3n th\u1ecb c\u00e1c kh\u1ed1i",
            "Show invisible characters": "Hi\u1ec3n th\u1ecb c\u00e1c k\u00fd t\u1ef1 \u1ea9n",
            "Words: {0}": "C\u00e1c t\u1eeb: {0}",
            "Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.": "D\u00e1n n\u1ed9i dung hi\u1ec7n t\u1ea1i \u0111ang trong ch\u1ebf \u0111\u1ed9 v\u0103n b\u1ea3n \u0111\u01a1n gi\u1ea3n. N\u1ed9i dung s\u1ebd \u0111\u01b0\u1ee3c d\u00e1n nh\u01b0 v\u0103n b\u1ea3n tr\u01a1n cho \u0111\u1ebfn khi b\u1ea1n thay \u0111\u1ed5i t\u00f9y ch\u1ecdn n\u00e0y.\n\nIf you are looking to paste rich content from Microsoft Word, try turning this option off. The editor will clean up text pasted from Word automatically.",
            "Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help": "Kh\u00f3 kh\u0103n khi s\u1eed d\u1ee5ng? H\u00e3y nh\u1ea5n Alt-Shift-H \u0111\u1ec3 gi\u00fap \u0111\u1ee1",
            "Rich Text Area. Press Control-Option-H for help.": "V\u00f9ng Rich Text. Nh\u1ea5n Control-Option-H \u0111\u1ec3 \u0111\u01b0\u1ee3c tr\u1ee3 gi\u00fap.",
            "You have unsaved changes are you sure you want to navigate away?": "C\u00e1c thay \u0111\u1ed5i b\u1ea1n v\u1eeba th\u1ef1c hi\u1ec7n s\u1ebd b\u1ecb m\u1ea5t n\u1ebfu b\u1ea1n \u0111i kh\u1ecfi trang n\u00e0y khi ch\u01b0a l\u01b0u b\u00e0i.",
            "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X\/C\/V keyboard shortcuts instead.": "Tr\u00ecnh duy\u1ec7t c\u1ee7a b\u1ea1n kh\u00f4ng h\u1ed7 tr\u1ee3 truy c\u1eadp tr\u1ef1c ti\u1ebfp v\u00e0o clipboard. Vui l\u00f2ng s\u1eed d\u1ee5ng c\u00e1c ph\u00edm t\u1eaft ho\u1eb7c menu ch\u1ec9nh s\u1eeda c\u1ee7a tr\u00ecnh duy\u1ec7t \u0111\u1ec3 thay th\u1ebf.",
            "Insert": "Ch\u00e8n",
            "File": "T\u1ec7p tin",
            "Edit": "Ch\u1ec9nh s\u1eeda",
            "Tools": "C\u00e1c c\u00f4ng c\u1ee5",
            ...
            "Table": "B\u1ea3ng",
            "Format": "\u0110\u1ecbnh d\u1ea1ng",
            "Toolbar Toggle": "Hi\u1ec7n ho\u1eb7c \u1ea9n thanh c\u00f4ng c\u1ee5",
            "Insert Read More tag": "Ch\u00e8n th\u1ebb \u0110\u1ecdc Th\u00eam",
            "Insert Page Break tag": "Th\u00eam th\u1ebb ng\u1eaft trang",
            "Read more...": "Xem chi ti\u1ebft...",
            "Distraction-free writing mode": "Ch\u1ebf \u0111\u1ed9 vi\u1ebft ch\u1ed1ng xao nh\u00e3ng",
            "No alignment": "Kh\u00f4ng c\u0103n l\u1ec1",
            "Remove": "X\u00f3a b\u1ecf",
            "Edit|button": "Ch\u1ec9nh s\u1eeda",
            "Paste URL or type to search": "D\u00e1n URL ho\u1eb7c g\u00f5 \u0111\u1ec3 t\u00ecm ki\u1ebfm",
            "Apply": "\u00c1p d\u1ee5ng",
            "Link options": "T\u00f9y ch\u1ecdn link",
            "Visual": "Tr\u1ef1c quan",
            "Text": "V\u0103n b\u1ea3n",
            "Add Media": "Th\u00eam Media",
            "Keyboard Shortcuts": "Ph\u00edm t\u1eaft",
            "Classic Block Keyboard Shortcuts": "Ph\u00edm t\u1eaft Block c\u01a1 b\u1ea3n",
            "Default shortcuts,": "Ph\u00edm t\u1eaft m\u1eb7c \u0111\u1ecbnh,",
            "Additional shortcuts,": "Ph\u00edm t\u1eaft b\u1ed5 sung,",
            "Focus shortcuts:": "C\u00e1c ph\u00edm t\u1eaft t\u1eadp trung:",
            "Inline toolbar (when an image, link or preview is selected)": "Thanh c\u00f4ng c\u1ee5 Inline (khi m\u1ed9t h\u00ecnh \u1ea3nh, li\u00ean k\u1ebft ho\u1eb7c xem tr\u01b0\u1edbc \u0111\u01b0\u1ee3c ch\u1ecdn)",
            "Editor menu (when enabled)": "Menu tr\u00ecnh so\u1ea1n th\u1ea3o (khi \u0111\u01b0\u1ee3c k\u00edch ho\u1ea1t)",
            "Editor toolbar": "Thanh c\u00f4ng c\u1ee5 so\u1ea1n th\u1ea3o",
            "Elements path": "\u0110\u01b0\u1eddng d\u1eabn",
            "Ctrl + Alt + letter:": "Ctrl + Alt + k\u00ed t\u1ef1:",
            "Shift + Alt + letter:": "Shift + Alt + k\u00ed t\u1ef1:",
            "Cmd + letter:": "Cmd + k\u00ed t\u1ef1:",
            "Ctrl + letter:": "Ctrl + k\u00ed t\u1ef1:",
            "Action": "T\u00e1c v\u1ee5",
            "Warning: the link has been inserted but may have errors. Please test it.": "C\u1ea3nh b\u00e1o: li\u00ean k\u1ebft \u0111\u00e3 \u0111\u01b0\u1ee3c ch\u00e8n nh\u01b0ng c\u00f3 th\u1ec3 c\u00f3 l\u1ed7i. Vui l\u00f2ng ki\u1ec3m tra n\u00f3.",
            "To move focus to other buttons use Tab or the arrow keys. To return focus to the editor press Escape or use one of the buttons.": "\u0110\u1ec3 \u0111\u1eb7t tr\u1ecdng t\u00e2m v\u00e0o c\u00e1c n\u00fat kh\u00e1c, h\u00e3y s\u1eed d\u1ee5ng ph\u00edm Tab ho\u1eb7c c\u00e1c ph\u00edm m\u0169i t\u00ean. \u0110\u1ec3 \u0111\u1eb7t l\u1ea1i v\u00e0o tr\u1ecdng t\u00e2m v\u00e0o khung so\u1ea1n th\u1ea3o, s\u1eed d\u1ee5ng ph\u00edm ESC.",
            "When starting a new paragraph with one of these formatting shortcuts followed by a space, the formatting will be applied automatically. Press Backspace or Escape to undo.": "Khi b\u1eaft \u0111\u1ea7u 1 \u0111o\u1ea1n m\u1edbi v\u1edbi 1 trong nh\u1eefng m\u1eabu n\u00e0y \u0111\u01b0\u1ee3c theo sau b\u1edfi 1 d\u1ea5u space, \u0111\u1ecbnh d\u1ea1ng s\u1ebd \u0111\u01b0\u1ee3c \u00e1p d\u1ee5ng t\u1ef1 \u0111\u1ed9ng. Nh\u1ea5n ph\u00edm Backspace ho\u1eb7c Escape \u0111\u1ec3 ho\u00e0n nguy\u00ean.",
            "The following formatting shortcuts are replaced when pressing Enter. Press Escape or the Undo button to undo.": "C\u00e1c ph\u00edm t\u1eaft \u0111\u1ecbnh d\u1ea1ng sau \u0111\u00e2y \u0111\u01b0\u1ee3c thay th\u1ebf khi nh\u1ea5n Enter. Nh\u1ea5n Escape ho\u1eb7c n\u00fat Undo \u0111\u1ec3 tr\u1edf l\u1ea1i.",
        ...
        tinymce.ScriptLoader.markDone('http://localhost/wordpress/wp-includes/js/tinymce/langs/vi.js');
    </script>
    <script type="text/javascript">
    ...
    <div id="wp-link-wrap" class="wp-core-ui" style="display: none" role="dialog" aria-labelledby="link-modal-title">
        <form id="wp-link" tabindex="-1">
            <input type="hidden" id="_ajax_linking_nonce" name="_ajax_linking_nonce" value="2cb97e5405"/>
            <h1 id="link-modal-title">Thêm/Sửa đường dẫn</h1>
                ...
                <div id="search-panel">
                    ...
                    <div id="most-recent-results" class="query-results" tabindex="0">
                        <div class="query-notice" id="query-notice-message">
                            <em class="query-notice-default">Thiếu từ khóa tìm kiếm. Hiển thị các bài viết mới
                                nhất.</em>
            ...
            <div class="submitbox">
                ...
                <div id="wp-link-update">
                    <input type="submit" value="Thêm liên kết" class="button button-primary" id="wp-link-submit"
                           name="wp-link-submit">
                </div>
            </div>
        </form>
