        ...
        <div id="wpadminbar" class="nojq nojs">
            <div class="quicklinks" id="wp-toolbar" role="navigation" aria-label="Thanh công cụ">
                <ul id='wp-admin-bar-root-default' class="ab-top-menu">
                    ...
                    <li id='wp-admin-bar-archive'><a class='ab-item' href='http://localhost/wordpress/shop/'>View
                            products</a></li>
                </ul>
        ...
        <div id="wpbody" role="main">
            ...
            <div id="wpbody-content">
                    ...
                    <div id="screen-options-wrap" class="hidden" tabindex="-1" aria-label="Khung Tùy Biến Màn Hình">
                        <form id='adv-settings' method='post'>
                            <fieldset class="metabox-prefs">
                                ...
                                <label><input class="hide-column-tog" name="sku-hide" type="checkbox" id="sku-hide"
                                              value="sku" checked='checked'/>SKU</label>
                                <label><input class="hide-column-tog" name="is_in_stock-hide" type="checkbox"
                                              id="is_in_stock-hide" value="is_in_stock" checked='checked'/>Stock</label>
                                <label><input class="hide-column-tog" name="price-hide" type="checkbox" id="price-hide"
                                              value="price" checked='checked'/>Price</label>
                                <label><input class="hide-column-tog" name="product_cat-hide" type="checkbox"
                                              id="product_cat-hide" value="product_cat"
                                              checked='checked'/>Categories</label>
                                <label><input class="hide-column-tog" name="product_tag-hide" type="checkbox"
                                              id="product_tag-hide" value="product_tag" checked='checked'/>Tags</label>
                                <label><input class="hide-column-tog" name="featured-hide" type="checkbox"
                                              id="featured-hide" value="featured" checked='checked'/>Featured</label>
                                <label><input class="hide-column-tog" name="date-hide" type="checkbox" id="date-hide"
                                              value="date" checked='checked'/>Date</label>
                            </fieldset>
                            <fieldset class="screen-options">
                                <legend>Phân trang</legend>
                                <label for="edit_product_per_page">Số đối tượng trên một trang.</label>
                                <input type="number" step="1" min="1" max="999" class="screen-per-page"
                                       name="wp_screen_options[value]"
                                       id="edit_product_per_page" maxlength="3"
                                       value="20"/>
                ...
                <div class="wrap">
                    ...
                    <a href="{{ route('product.v2.create') }}"
                    ...
                    <ul class='subsubsub'>
                        <li class='all'><a href="edit.php?post_type=product" class="current" aria-current="page">Tất cả
                                <span class="count">(1)</span></a> |
                        </li>
                        <li class='publish'><a href="edit.php?post_status=publish&#038;post_type=product">Đã xuất bản
                                <span class="count">(1)</span></a> |
                        </li>
                        <li class='byorder'><a
                                    href="/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=menu_order+title&#038;order=ASC"
                                    class="">Sorting</a></li>
                    </ul>
                    <form id="posts-filter" method="get">
                        ...
                        <p class="search-box">
                            ...
                            <input type="submit" id="search-submit" class="button" value="Search products"/></p>

                        <input type="hidden" name="post_status" class="post_status_page" value="all"/>
                        <input type="hidden" name="post_type" class="post_type_page" value="product"/>


                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="6efbcccf3a"/><input type="hidden"
                                                                                                      name="_wp_http_referer"
                                                                                                      value="/wordpress/wp-admin/edit.php?post_type=product"/>
                        <div class="tablenav top">
                            ...
                            <div class="alignleft actions">
                                <select name='product_cat' id='product_cat' class='dropdown_product_cat'>
                                    ...
                                    <option class="level-0" value="gi-co">gì cơ&nbsp;&nbsp;(0)</option>
                                ...
                                </select><select name="stock_status">
                                    <option value="">Filter by stock status</option>
                                    <option value="instock">In stock</option>
                                    <option value="outofstock">Out of stock</option>
                                    <option value="onbackorder">On backorder</option>
                                </select><input type="submit" name="filter_action" id="post-query-submit" class="button"
                                                value="Lọc"/></div>
...
<span class="tablenav-pages-navspan button disabled" aria-hidden="true">&raquo;</span></span></div>
                        ...
                        <table class="wp-list-table widefat fixed striped table-view-list posts">
                            ...
                            <tr>
                                ...
                                <th scope="col" id='thumb' class='manage-column column-thumb'><span
                                            class="wc-image tips" data-tip="Image">Image</span></th>
                                <th scope="col" id='name'
                                    class='manage-column column-name column-primary sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=title&#038;order=asc"><span>Name</span><span
                                                class="sorting-indicator"></span></a></th>
                                <th scope="col" id='sku' class='manage-column column-sku sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=sku&#038;order=asc"><span>SKU</span><span
                                                class="sorting-indicator"></span></a></th>
                                <th scope="col" id='is_in_stock' class='manage-column column-is_in_stock'>Stock</th>
                                <th scope="col" id='price' class='manage-column column-price sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=price&#038;order=asc"><span>Price</span><span
                                                class="sorting-indicator"></span></a></th>
                                <th scope="col" id='product_cat' class='manage-column column-product_cat'>Categories
                                </th>
                                <th scope="col" id='product_tag' class='manage-column column-product_tag'>Tags</th>
                                <th scope="col" id='featured' class='manage-column column-featured'><span
                                            class="wc-featured parent-tips" data-tip="Featured">Featured</span></th>
                                <th scope="col" id='date' class='manage-column column-date sortable asc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=date&#038;order=desc"><span>Date</span><span
                                                class="sorting-indicator"></span></a></th>
                            </tr>
                            </thead>
				...
				&#8220;hihi&#8221; đã bị khóa				</span>
                                    </div>
                                </th>
                                <td class='thumb column-thumb' data-colname="Image"><a
                                            href="http://localhost/wordpress/wp-admin/post.php?post=42&#038;action=edit"><img
                                                width="150" height="150"
                                                src="http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder-150x150.png"
                                                class="woocommerce-placeholder wp-post-image" alt="Placeholder"
                                                decoding="async" loading="lazy"
                                                srcset="http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder-150x150.png 150w, http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder-300x300.png 300w, http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder-1024x1024.png 1024w, http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder-768x768.png 768w, http://localhost/wordpress/wp-content/uploads/woocommerce-placeholder.png 1200w"
                                ...
                                <td class='name column-name has-row-actions column-primary' data-colname="Name"><strong><a
                                                class="row-title"
                                                href="http://localhost/wordpress/wp-admin/post.php?post=42&#038;action=edit">hihi</a></strong>
                                    <div class="hidden" id="inline_42">
                                        <div class="post_title">hihi</div>
                                        <div class="post_name">hihi</div>
                                        ...
                                        <div class="post_category" id="product_cat_42">18</div>
                                        <div class="tags_input" id="product_tag_42"></div>
                                    ...
                                    <div class="row-actions"><span class='id'>ID: 42 | </span><span class='edit'><a
                                                    href="http://localhost/wordpress/wp-admin/post.php?post=42&amp;action=edit"
                                                    aria-label="Sửa &#8220;hihi&#8221;">Chỉnh sửa</a> | </span><span
                                                class='inline hide-if-no-js'><button type="button"
                                                                                     class="button-link editinline"
                                                                                     aria-label="Chỉnh sửa nhanh &#8220;hihi&#8221;"
                                                                                     aria-expanded="false">Sửa nhanh</button> | </span><span
                                                class='trash'><a
                                                    href="http://localhost/wordpress/wp-admin/post.php?post=42&amp;action=trash&amp;_wpnonce=77d5759b1f"
                                                    class="submitdelete"
                                                    aria-label="Bỏ &#8220;hihi&#8221; vào thùng rác">Thùng rác</a> | </span><span
                                                class='view'><a href="http://localhost/wordpress/product/hihi/"
                                                                rel="bookmark"
                                                                aria-label="Xem &#8220;hihi&#8221;">Xem</a> | </span><span
                                                class='duplicate'><a
                                                    href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&amp;action=duplicate_product&amp;post=42&amp;_wpnonce=5abbc78e90"
                                                    aria-label="Make a duplicate from this product" rel="permalink">Duplicate</a></span>
                                    </div>
                                    <button type="button" class="toggle-row"><span class="screen-reader-text">Hiển thị chi tiết</span>
                                    </button>
                                </td>
                                <td class='sku column-sku' data-colname="SKU"><span class="na">&ndash;</span></td>
                                <td class='is_in_stock column-is_in_stock' data-colname="Stock">
                                    <mark class="instock">In stock</mark>
                                </td>
                                <td class='price column-price' data-colname="Price"><span class="na">&ndash;</span></td>
                                <td class='product_cat column-product_cat' data-colname="Categories"><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?product_cat=uncategorized&#038;post_type=product ">Uncategorized</a>
                                </td>
                                <td class='product_tag column-product_tag' data-colname="Tags"><span
                                            class="na">&ndash;</span></td>
                                <td class='featured column-featured' data-colname="Featured"><a
                                            href="http://localhost/wordpress/wp-admin/admin-ajax.php?action=woocommerce_feature_product&#038;product_id=42&#038;_wpnonce=8dc4e62bed"
                                            aria-label="Toggle featured"><span class="wc-featured not-featured tips"
                                                                               data-tip="No">No</span></a></td>
                                <td class='date column-date' data-colname="Date">Đã xuất bản<br/>18/07/2023 lúc 3:18
                                    sáng
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td class='manage-column column-cb check-column'><label class="screen-reader-text"
                                                                                        for="cb-select-all-2">Chọn toàn
                                        bộ</label><input id="cb-select-all-2" type="checkbox"/></td>
                                <th scope="col" class='manage-column column-thumb'><span class="wc-image tips"
                                                                                         data-tip="Image">Image</span>
                                </th>
                                <th scope="col" class='manage-column column-name column-primary sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=title&#038;order=asc"><span>Name</span><span
                                                class="sorting-indicator"></span></a></th>
                                <th scope="col" class='manage-column column-sku sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=sku&#038;order=asc"><span>SKU</span><span
                                                class="sorting-indicator"></span></a></th>
                                <th scope="col" class='manage-column column-is_in_stock'>Stock</th>
                                <th scope="col" class='manage-column column-price sortable desc'><a
                                            href="http://localhost/wordpress/wp-admin/edit.php?post_type=product&#038;orderby=price&#038;order=asc"><span>Price</span><span
                                                class="sorting-indicator"></span></a></th>
                                ...
                                <th scope="col" class='manage-column column-featured'><span
                                            class="wc-featured parent-tips" data-tip="Featured">Featured</span></th>
                        ...
                        <div class="tablenav bottom">
                            ...
                            <div class="alignleft actions bulkactions">
                                <label for="bulk-action-selector-bottom" class="screen-reader-text">Lựa chọn thao tác
                                    hàng loạt</label><select name="action2" id="bulk-action-selector-bottom">
                                    <option value="-1">Hành động</option>
                                    <option value="edit" class="hide-if-no-js">Chỉnh sửa</option>
                                    <option value="trash">Bỏ vào thùng rác</option>
                                </select>
...
<span class="tablenav-pages-navspan button disabled" aria-hidden="true">&raquo;</span></span></div>
                                        ...
                                        <fieldset class="inline-edit-col-left">
                                            ...
                                            <div class="inline-edit-col">
                                                ...
                                                <fieldset class="inline-edit-date">
                                                    ...
                                                    <div class="timestamp-wrap"><label><span class="screen-reader-text">Tháng</span><select
                                                                    class="form-required" name="mm">
                                            ...
                                            <div class="inline-edit-col">
                                                ...
                                                <ul class="cat-checklist product_cat-checklist">
                                                    ...
                                                    <li id='product_cat-18' class="popular-category"><label
                                                                class="selectit"><input value="18" type="checkbox"
                                                                                        name="tax_input[product_cat][]"
                                                                                        id="in-product_cat-18"/>
                                                            Uncategorized</label></li>

                                                    <li id='product_cat-19'><label class="selectit"><input value="19"
                                                                                                           type="checkbox"
                                                                                                           name="tax_input[product_cat][]"
                                                                                                           id="in-product_cat-19"/>
                                                            gì cơ</label></li>
                                                </ul>
                                            ...
                                            <div class="inline-edit-col">
                                                ...
                                                <div class="inline-edit-tags-wrap">
                                                    <label class="inline-edit-tags">
                                                        ...
                                                        <textarea data-wp-taxonomy="product_tag" cols="22" rows="1"
                                                                  name="tax_input[product_tag]"
                                                                  class="tax_input_product_tag"
                                                                  aria-describedby="inline-edit-product_tag-desc"></textarea>
                                                    </label>
                                                    <p class="howto" id="inline-edit-product_tag-desc">Separate tags
                                                        with commas</p>
                                                </div>
					...
					<input type="text" name="_sku" class="text sku" value="">
                                                ...
                                                <div class="price_fields">
                                                    <label>
                                                        ...
                                                        <span class="input-text-wrap">
					<input type="text" name="_regular_price" class="text wc_input_price regular_price"
                           placeholder="Regular price" value="">
				</span>
                                                    </label>
                                                    <br class="clear"/>
                                                    <label>
                                                        ...
                                                        <span class="input-text-wrap">
					<input type="text" name="_sale_price" class="text wc_input_price sale_price"
						...
						<input type="text" name="_weight" class="text weight" placeholder="0" value="">
                                                    ...
                                                    <div class="inline-edit-group dimensions">
                                                        <div>
                                                            <span class="title">L/W/H</span>
                                                            <span class="input-text-wrap">
							<input type="text" name="_length" class="text wc_input_decimal length" placeholder="Length"
                                   value="">
							<input type="text" name="_width" class="text wc_input_decimal width" placeholder="Width"
                                   value="">
							<input type="text" name="_height" class="text wc_input_decimal height" placeholder="Height"
                                   value="">
						</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="inline-edit-group">
                                                    <span class="title">Shipping class</span>
                                                    <span class="input-text-wrap">
				<select class="shipping_class" name="_shipping_class">
					<option value="_no_shipping_class">No shipping class</option>
									</select>
			</span>
                                                </div>
					...
					<select class="visibility" name="_visibility">
						<option value="visible">Catalog &amp; search</option><option value="catalog">Catalog</option><option
                                value="search">Search</option><option value="hidden">Hidden</option>					</select>
				</span>
                                                    </label>
                                                ...
                                                <div class="inline-edit-group manage_stock_field">
                                                    <label class="manage_stock">
                                                        ...
                                                        <span class="checkbox-title">Manage stock?</span>
                                                    </label>
                                                </div>
				...
				<select class="stock_status" name="_stock_status">
					<option value="" id="stock_status_no_change">— No Change —</option><option
                            value="instock">In stock</option><option value="outofstock">Out of stock</option><option
                            value="onbackorder">On backorder</option>				</select>
				<div class="wc-quick-edit-warning" style="display:none">
					This will change the stock status of all variations.</p>
				</div>
			</span>
                                                </label>
                                                ...
                                                <div class="stock_fields">
                                                    <label class="stock_qty_field">
                                                        <span class="title">Stock qty</span>
                                                        <span class="input-text-wrap">
						<input type="number" name="_stock" class="text stock" step="any" value="">
                                                ...
                                                <label class="alignleft backorder_field">
                                                    <span class="title">Backorders?</span>
                                                    <span class="input-text-wrap">
				<select class="backorders" name="_backorders">
					<option value="no">Do not allow</option><option value="notify">Allow, but notify customer</option><option
                            value="yes">Allow</option>				</select>
			</span>
                                                </label>
                                        ...
                                        <div class="submit inline-edit-save">
                                            <input type="hidden" id="_inline_edit" name="_inline_edit"
                                                   value="ac6eefb1ac"/>
                                            <button type="button" class="button button-primary save">Cập nhật</button>
                            ...
                            <tr id="bulk-edit"
                                ...
                                <td colspan="10" class="colspanchange">
                                    <div class="inline-edit-wrapper" role="region" aria-labelledby="bulk-edit-legend">
                                        <fieldset class="inline-edit-col-left">
                                            <legend class="inline-edit-legend" id="bulk-edit-legend">Chỉnh sửa hàng
                                                loạt
                                            </legend>
                                            <div class="inline-edit-col">
                                            ...
                                            <div class="inline-edit-col">
                                                ...
                                                <div class="inline-edit-group wp-clearfix">
                                                    ...
                                                    <label class="alignleft">
                                                        ...
                                                        <select name="comment_status">
                                                            <option value="">&mdash; Không đổi &mdash;</option>
                                                ...
                                                <div class="inline-edit-group wp-clearfix">
                                                    ...
                                                    <label class="inline-edit-status alignleft">
                                                        <span class="title">Trạng thái</span>
                                                        <select name="_status">
                                                            <option value="-1">&mdash; Không đổi &mdash;</option>
					...
					<select class="change_regular_price change_to" name="change_regular_price">
						<option value="">— No change —</option><option value="1">Change to:</option><option value="2">Increase existing price by (fixed amount or %):</option><option
                                value="3">Decrease existing price by (fixed amount or %):</option>					</select>
				</span>
                                                    </label>
					...
					<select class="change_sale_price change_to" name="change_sale_price">
						<option value="">— No change —</option><option value="1">Change to:</option><option value="2">Increase existing sale price by (fixed amount or %):</option><option
                                value="3">Decrease existing sale price by (fixed amount or %):</option><option
                                value="4">Set to regular price decreased by (fixed amount or %):</option>					</select>
				</span>
                                                    </label>
                                                    <label class="change-input">
						...
						<select class="change_weight change_to" name="change_weight">
							<option value="">— No change —</option><option value="1">Change to:</option>						</select>
					</span>
                                                    </label>
                                                    <label class="change-input">
                                                        <input
				...
				<select class="shipping_class" name="_shipping_class">
					...
					<option value="_no_shipping_class">No shipping class</option>
                                                ...
                                                <label>
                                                    ...
                                                    <span class="input-text-wrap">
				<select class="visibility" name="_visibility">
					<option value="">— No change —</option><option value="visible">Catalog &amp; search</option><option
                            value="catalog">Catalog</option><option value="search">Search</option><option
                            value="hidden">Hidden</option>				</select>
			</span>
                                                </label>
                                                <label>
				...
				<select class="featured" name="_featured">
					<option value="">— No change —</option><option value="yes">Yes</option><option
                            value="no">No</option>				</select>
                                                ...
                                                <label>
                                                    ...
                                                    <span class="input-text-wrap">
				<select class="stock_status" name="_stock_status">
					<option value="">— No Change —</option><option value="instock">In stock</option><option
                            value="outofstock">Out of stock</option><option value="onbackorder">On backorder</option>				</select>
			</span>
                                                </label>
					...
					<select class="manage_stock" name="_manage_stock">
						...
						<select class="change_stock change_to" name="change_stock">
							<option value="">— No change —</option><option value="1">Change to:</option><option
                                    value="2">Increase existing stock by:</option><option value="3">Decrease existing stock by:</option>						</select>
					</span>
                                                    </label>
                                                    <label class="change-input">
                                                        <input type="text" name="_stock" class="text stock"
                                                               placeholder="Stock qty" step="any" value="">
                                                    </label>
                                                </div>
                                                ...
                                                <label>
                                                    ...
                                                    <span class="input-text-wrap">
					<select class="backorders" name="_backorders">
						<option value="">— No Change —</option><option value="no">Do not allow</option><option
                                value="notify">Allow, but notify customer</option><option value="yes">Allow</option>					</select>
				</span>
                                                </label>


                                                <label>
                                                    <span class="title">Sold individually?</span>
                                                    <span class="input-text-wrap">
    ...
    <img style="position: fixed;"
         src="https://pixel.wp.com/t.gif?_en=wcadmin_products_view&#038;_ts=1689654379389&#038;_via_ua=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F113.0.0.0+Safari%2F537.36&#038;_via_ip=%3A%3A1&#038;_lg=vi-VN%2Cvi%3Bq%3D0.9%2Cfr-FR%3Bq%3D0.8%2Cfr%3Bq%3D0.7%2Cen-US%3Bq%3D0.6%2Cen%3Bq%3D0.5&#038;_dr=http%3A%2F%2Flocalhost%2Fwordpress%2Fwp-admin%2Fedit-tags.php%3Ftaxonomy%3Dproduct_cat%26post_type%3Dproduct&#038;_dl=http%3A%2F%2Flocalhost%2Fwordpress%2Fwp-admin%2Fedit.php%3Fpost_type%3Dproduct&#038;_ut=anon&#038;_ui=woo%3AEEBklBp2rgtxED1NngC1MGG8&#038;url=http%3A%2F%2Flocalhost%2Fwordpress&#038;blog_lang=vi&#038;blog_id=0&#038;products_count=0&#038;wc_version=7.9.0&#038;browser_type=php-agent"/>
                        ...
                        <div class="advanced-settings hidden">
                            ...
                            <div class="advanced-link">
    								<span class="setting link-target">
    									<input type="checkbox" id="image-details-link-target"
                                ...
                                <span class="setting link-class-name">
    									...
    									<input type="text" id="image-details-link-css-class"
        ...
        window.wcTracks.recordEvent = function (name, properties) {
            ...
            eventProperties = {
                ...eventProperties, ...{
                    ...
                    "_dr": "http:\/\/localhost\/wordpress\/wp-admin\/edit-tags.php?taxonomy=product_cat&post_type=product",
                    "_dl": "http:\/\/localhost\/wordpress\/wp-admin\/edit.php?post_type=product",
