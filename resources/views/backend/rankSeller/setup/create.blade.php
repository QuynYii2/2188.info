...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title">{{ __('home.Thêm mới setup rank') }}</h5>
        </div>
        <div class="container">
            <form action="{{route('seller.setup.create')}}" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="copper_price">{{ __('home.Hạn mức COPPER') }}:</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="silver_price">{{ __('home.Hạn mức SILVER') }}:</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="gold_price">{{ __('home.Hạn mức GOLD') }}:</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="diamond_price">{{ __('home.Hạn mức DIAMOND') }}:</label>
