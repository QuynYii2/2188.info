            ...
            <table class="table table-bordered">
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>10</td>
                        <td>
                            <a href="{{ route('seller.products.edit', $category->id) }}" class="btn btn-primary">Sửa</a>
                            <form action="{{ route('seller.products.destroy', $category->id) }}" method="POST" style="display: inline-block">
                                @csrf
                                @method('DELETE')
