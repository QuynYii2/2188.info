                                    ...
                                    <tr>
                                        <td class="float-left">
                                            <button class="text-decoration-none" data-toggle="modal"
                                                    ...
                                                    style="cursor: pointer">{{ $loop->index+1 }}</button>
                                            <div class="modal fade" id="updateOrderProcess{{$order->id}}" tabIndex="-1"
                                                 role="dialog"
                                                 aria-labelledby="editModalLabel">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                    ...
                                    <tr>
                                        <td class="float-left">
                                            <button class="text-decoration-none" data-toggle="modal"
                                                    ...
                                                    style="cursor: pointer">{{ $loop->index+1 }}</button>
                                            <div class="modal fade" id="updateOrderDelivery{{$order->id}}" tabIndex="-1"
                                                 role="dialog"
                                                 aria-labelledby="editModalLabel">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                    ...
                                    <tr>
                                        <td class="float-left">
                                            <button class="text-decoration-none" data-toggle="modal"
                                                    ...
                                                    style="cursor: pointer">{{ $loop->index+1 }}</button>
                                            <div class="modal fade" id="updateOrderCancel{{$order->id}}" tabIndex="-1"
                                                 role="dialog"
                                                 aria-labelledby="editModalLabel">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
