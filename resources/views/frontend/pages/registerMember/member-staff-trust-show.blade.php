    ...
    <div class="background container-fluid pt-3 justify-content-center pb-3">
        <div class="">
            ...
            <table class="table element-bordered text-center" id="tableMemberShip">
                ...
                <tr>
                    <th rowspan="2" scope="col">{{ __('auth.Position') }}</th>
                    <th rowspan="2" scope="col">{{ __('auth.Work') }}</th>
                    <th colspan="2" scope="col">{{ __('auth.Name') }}</th>
                    <th rowspan="2" scope="col">{{ __('auth.Phone number') }}</th>
                    <th rowspan="2" scope="col">E-MAIL</th>
                    <th rowspan="2" scope="col">SNS</th>
                </tr>
                <tr>
                    <th scope="col">{{ __('auth.Language English') }}</th>
                    <th scope="col">{{ __('auth.Language Region') }}</th>
                </tr>
                @php
                    if ($memberSource){
