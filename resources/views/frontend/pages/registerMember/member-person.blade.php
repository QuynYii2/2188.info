...
<div class="">
    <form class="p-3 form_info-member-person" action="{{route('register.member.source')}}" method="post" id="formRegisterMember">
        ...
        @if(!Auth::check())
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="password" class="label_form">{{ __('home.Password') }}  <span class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="password" name="password"
                           placeholder="{{ __('home.Password') }}" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="passwordConfirm" class="label_form">{{ __('home.Re-Password') }}  <span class="text-danger">*</span></label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="phoneNumber" class="label_form">{{ __('home.Phone Number') }}  <span class="text-danger">*</span></label>
         ...
         <label for="sns_account" class="label_form">{{ __('home.SNS Account') }}  <span class="text-danger">*</span></label>
         <div class="form-group">
