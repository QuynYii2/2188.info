                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('show.register.member', \App\Enums\RegisterMember::VENDOR)}}" class="btn btn-primary">Đăng kí ngay</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('show.register.member', \App\Enums\RegisterMember::POWER_VENDOR)}}" class="btn btn-primary">Đăng kí ngay</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('show.register.member', \App\Enums\RegisterMember::PRODUCTION)}}" class="btn btn-primary">Đăng kí ngay</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('show.register.member', \App\Enums\RegisterMember::POWER_PRODUCTION)}}" class="btn btn-primary">Đăng kí ngay</a>
                                </div>
                            </div>
                        </div>
                    </div>
