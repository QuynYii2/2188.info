...
@endphp
<div class="total_shop" id="total_shop">{{count($cartViews)}}</div>
...
<script>
    ...
    var urldeleteCart = `{{route('deleteCart',  ['id' => ':cart'])}}`;
    var tokenCart = `{{csrf_token()}}`;
</script>
<script src="{{asset('js/frontend/pages/cart-header.js')}}"></script>