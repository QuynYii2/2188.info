            ...
            <div id="form-info" class="col-md-12 col-lg-6 border-bottom border-right">
                ...
                <form>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="form-check col-md-2 col-12 offset-1">
                ...
                <div class="pt-2">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <button class="btn-outline-primary btn desktop-button" data-toggle="modal" data-target="#modal-edit-phone">
                                {{ __('home.update') }}
                            </button>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <button class="btn-outline-primary btn desktop-button" data-toggle="modal" data-target="#modal-edit-email">
                                {{ __('home.update') }}
                            </button>
                            <svg class="mobile-button" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 512 512" data-toggle="modal" data-target="#modal-edit-phone">
                ...
                <div class="pb-3">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <button class="btn-outline-primary btn desktop-button" data-toggle="modal" data-target="#modal-edit-password">
                                {{ __('home.update') }}
                            </button>
                            <svg class="mobile-button" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 512 512" data-toggle="modal" data-target="#modal-edit-phone">
