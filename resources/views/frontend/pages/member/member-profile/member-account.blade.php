...
@section('content')
    @php
        ...
        $memberId = \App\Models\MemberRegisterPersonSource::where('member_id',$getMemberId)->get();
    @endphp
...
{{--    </div>--}}
    ...
    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-2" role="tabpanel"
             aria-labelledby="nav-contact-tab">
            @include('frontend.pages.member.detail-member-person')
        </div>
        ...
        <div class="tab-pane fade" id="nav-4" role="tabpanel"
             aria-labelledby="nav-contact-tab">
            @include('frontend.pages.member.tab-child-staff')
        </div>
    </div>
